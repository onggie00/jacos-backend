      ...
      if(isset($headers['x-token']))
        ...
        if (empty($cek_email)) {
          ...
          if ($this->post("sekolah_asal") > 0) {
            $sekolah_asal = $this->mymodel->getbywhere("list_sekolah_tk", "id_list_sekolah_tk",$this->post("sekolah_asal"),"row")->nama_sekolah;
          ...
          //cek email duplicate
          $cek_email = $this->mymodel->withquery("select * from siswa_sd where email = '".$this->post("email")."'", "row");
          if(!empty($cek_email)){
            ...
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->mymodel->withquery("select va_number_bri, id_siswa_sd as id_siswa from siswa_sd where va_number_bri like '".$brivaNo.date('y', strtotime('+1 years'))."01%' and va_number_bri != '' and is_mutasi = '2' order by id_siswa_sd DESC","row");
