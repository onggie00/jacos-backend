...
<section class="content-header">
    <h1>
        Jurusan        <small><?= cclang('new', ['Jurusan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Jurusan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="passing_grade" id="passing_grade" placeholder="Passing Grade" value="<?= set_value('passing_grade'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              <select  class="form-control chosen chosen-select-deselect" name="tahun_ajaran" id="tahun_ajaran" data-placeholder="Select Tahun Ajaran" >
                                    ...
                                    <option value="<?= str_replace('/', '-', $row->label) ?>"><?= str_replace('/', '-', $row->label); ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pt_jurusan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
