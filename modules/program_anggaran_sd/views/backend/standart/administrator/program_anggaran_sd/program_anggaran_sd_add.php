...
<section class="content-header">
    <h1>
        ...
        <small><?= cclang('new', ['Program Anggaran SD']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control chosen chosen-select-deselect" onchange="get_program()" name="nomor_program" id="nomor_program" data-placeholder="Pilih Nomor Program">
                                <option value=""></option>
                                <?php foreach ($this->mymodel->getbywhere("program_anggaran","is_active = '1' and jenjang=","SD","result") as $row): ?>
                                <option value="<?= $row->nomor_program ?>"><?= $row->nomor_program . ' - ' . $row->nama_program . ' (' . $row->jenjang . ')'; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <small class="info help-block">Pilih program anggaran SD. Opsi menampilkan nomor, nama, dan jenjang program.</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input class="data_file" name="program_anggaran_sd_file_proposal_pengajuan_uuid" id="program_anggaran_sd_file_proposal_pengajuan_uuid" type="hidden" value="<?= set_value('program_anggaran_sd_file_proposal_pengajuan_uuid'); ?>">
                            <input class="data_file" name="program_anggaran_sd_file_proposal_pengajuan_name" id="program_anggaran_sd_file_proposal_pengajuan_name" type="hidden" value="<?= set_value('program_anggaran_sd_file_proposal_pengajuan_name'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input class="data_file" name="program_anggaran_sd_file_proposal_keuangan_uuid" id="program_anggaran_sd_file_proposal_keuangan_uuid" type="hidden" value="<?= set_value('program_anggaran_sd_file_proposal_keuangan_uuid'); ?>">
                            <input class="data_file" name="program_anggaran_sd_file_proposal_keuangan_name" id="program_anggaran_sd_file_proposal_keuangan_name" type="hidden" value="<?= set_value('program_anggaran_sd_file_proposal_keuangan_name'); ?>">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function get_program(){
        ...
        $.ajax({
            type: "GET",
            url: BASE_URL + "administrator/program_anggaran_sd/get_program/" + nomor_program,
    ...
    function resetForm() {
        $('#form_program_anggaran_sd').trigger('reset');
    ...
    $(document).ready(function(){
        ...
        $('.btn_save').click(function(){
            ...
            $.ajax({
                url: BASE_URL + '/administrator/program_anggaran_sd/add_save',
                type: 'POST',
                dataType: 'json',
                data: data_post,
            })
            .done(function(res) {
                ...
                if(res.success) {
                    var id_file_proposal_pengajuan = $('#program_anggaran_sd_file_proposal_pengajuan_galery').find('li').attr('qq-file-id');
                    var id_file_proposal_keuangan = $('#program_anggaran_sd_file_proposal_keuangan_galery').find('li').attr('qq-file-id');
                    ...
                    if (typeof id_file_proposal_pengajuan !== 'undefined') {
                        $('#program_anggaran_sd_file_proposal_pengajuan_galery').fineUploader('deleteFile', id_file_proposal_pengajuan);
                    }
                    if (typeof id_file_proposal_keuangan !== 'undefined') {
                        $('#program_anggaran_sd_file_proposal_keuangan_galery').fineUploader('deleteFile', id_file_proposal_keuangan);
                    }
