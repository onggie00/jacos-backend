...
<section class="content-header">
    <h1>
        Presensi Tadarus        <small>Edit Presensi Tadarus</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Presensi Tadarus</h5>
                            <hr>
                        </div>
                    <?= form_open('', array(
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control datetimepicker" name="tanggal" id="tanggal" placeholder="Pilih tanggal" value="<?= $presensi_tadarus->tanggal; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control chosen chosen-select" name="jenjang" id="jenjang" data-placeholder="Pilih Jenjang" required>
                                ...
                                <option value="<?= $j['code']; ?>" <?= (strtoupper($presensi_tadarus->jenjang) == $j['code']) ? 'selected' : ''; ?>><?= $j['label']; ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control chosen chosen-select" name="id_kelas" id="id_kelas" data-placeholder="Pilih Kelas" required>
                                ...
                                <option value="<?= $k->id_kelas; ?>" <?= ($presensi_tadarus->kelas == $k->label) ? 'selected' : ''; ?>><?= $k->label; ?></option>
                                <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control chosen chosen-select" name="id_siswa_aktif" id="id_siswa_aktif" data-placeholder="Pilih Siswa" required>
                                <option value="<?= $presensi_tadarus->id_siswa_aktif; ?>"><?= $presensi_tadarus->nama_lengkap; ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control chosen chosen-select" name="status_hadir" id="status_hadir" required>
                                <option value="Hadir" <?= ($presensi_tadarus->status_hadir == 'Hadir') ? 'selected' : ''; ?>>Hadir</option>
                                <option value="Sakit" <?= ($presensi_tadarus->status_hadir == 'Sakit') ? 'selected' : ''; ?>>Sakit</option>
                                <option value="Izin" <?= ($presensi_tadarus->status_hadir == 'Izin') ? 'selected' : ''; ?>>Izin</option>
                                <option value="Alfa" <?= ($presensi_tadarus->status_hadir == 'Alfa') ? 'selected' : ''; ?>>Alfa</option>
                            </select>
                        </div>
                    </div>

                    <div id="nilai_section" <?= ($presensi_tadarus->status_hadir != 'Hadir') ? 'style="display:none"' : ''; ?>>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Kehadiran <i class="required">*</i></label>
                            <div class="col-sm-6">
                                <div class="rating-group">
                                    <input type="radio" name="kehadiran" id="k1" value="1" <?= ($presensi_tadarus->kehadiran == 1) ? 'checked' : ''; ?>><label for="k1" class="rating-label" title="Perlu Bimbingan">1</label>
                                    <input type="radio" name="kehadiran" id="k2" value="2" <?= ($presensi_tadarus->kehadiran == 2) ? 'checked' : ''; ?>><label for="k2" class="rating-label" title="Cukup">2</label>
                                    <input type="radio" name="kehadiran" id="k3" value="3" <?= ($presensi_tadarus->kehadiran == 3) ? 'checked' : ''; ?>><label for="k3" class="rating-label" title="Baik">3</label>
                                    <input type="radio" name="kehadiran" id="k4" value="4" <?= ($presensi_tadarus->kehadiran == 4) ? 'checked' : ''; ?>><label for="k4" class="rating-label" title="Sangat Baik">4</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="rating-group">
                                    <input type="radio" name="kelengkapan" id="l1" value="1" <?= ($presensi_tadarus->kelengkapan == 1) ? 'checked' : ''; ?>><label for="l1" class="rating-label" title="Perlu Bimbingan">1</label>
                                    <input type="radio" name="kelengkapan" id="l2" value="2" <?= ($presensi_tadarus->kelengkapan == 2) ? 'checked' : ''; ?>><label for="l2" class="rating-label" title="Cukup">2</label>
                                    <input type="radio" name="kelengkapan" id="l3" value="3" <?= ($presensi_tadarus->kelengkapan == 3) ? 'checked' : ''; ?>><label for="l3" class="rating-label" title="Baik">3</label>
                                    <input type="radio" name="kelengkapan" id="l4" value="4" <?= ($presensi_tadarus->kelengkapan == 4) ? 'checked' : ''; ?>><label for="l4" class="rating-label" title="Sangat Baik">4</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="rating-group">
                                    <input type="radio" name="adab" id="a1" value="1" <?= ($presensi_tadarus->adab == 1) ? 'checked' : ''; ?>><label for="a1" class="rating-label" title="Perlu Bimbingan">1</label>
                                    <input type="radio" name="adab" id="a2" value="2" <?= ($presensi_tadarus->adab == 2) ? 'checked' : ''; ?>><label for="a2" class="rating-label" title="Cukup">2</label>
                                    <input type="radio" name="adab" id="a3" value="3" <?= ($presensi_tadarus->adab == 3) ? 'checked' : ''; ?>><label for="a3" class="rating-label" title="Baik">3</label>
                                    <input type="radio" name="adab" id="a4" value="4" <?= ($presensi_tadarus->adab == 4) ? 'checked' : ''; ?>><label for="a4" class="rating-label" title="Sangat Baik">4</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="rating-group">
                                    <input type="radio" name="keaktifan" id="i1" value="1" <?= ($presensi_tadarus->keaktifan == 1) ? 'checked' : ''; ?>><label for="i1" class="rating-label" title="Perlu Bimbingan">1</label>
                                    <input type="radio" name="keaktifan" id="i2" value="2" <?= ($presensi_tadarus->keaktifan == 2) ? 'checked' : ''; ?>><label for="i2" class="rating-label" title="Cukup">2</label>
                                    <input type="radio" name="keaktifan" id="i3" value="3" <?= ($presensi_tadarus->keaktifan == 3) ? 'checked' : ''; ?>><label for="i3" class="rating-label" title="Baik">3</label>
                                    <input type="radio" name="keaktifan" id="i4" value="4" <?= ($presensi_tadarus->keaktifan == 4) ? 'checked' : ''; ?>><label for="i4" class="rating-label" title="Sangat Baik">4</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="well well-sm" style="margin:0">
                                    <strong id="preview_total"><?= $presensi_tadarus->total_nilai; ?></strong> 
                                    <?php
                                    $total = (float) $presensi_tadarus->total_nilai;
...
$(document).ready(function(){
    ...
    $('.btn_save').click(function(){
        ...
        $.ajax({
            url: BASE_URL + '/administrator/presensi_tadarus/edit_save/<?= $presensi_tadarus->id_presensi_tadarus; ?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
