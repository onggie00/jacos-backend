...
<section class="content-header">
    <h1>
        Presensi Pelatih FT        <small><?= cclang('new', ['Presensi Pelatih FT']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Presensi Pelatih FT']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_presensi_pelatih_ft/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
