...
class Pendaftaran_sd extends REST_Controller {
    ...
    public function index_post()
    {
      ...
      if(isset($headers['x-token']))
        ...
        //cek email
        $cek_email = $this->second_db->withquery("select id_siswa_sd from calon_siswa_sd where email like '%".$this->db->escape_like_str($this->post("email"))."%' and is_show = 1","row");
        ...
        if (empty($cek_email)) {
          ...
          //cek email duplicate
          $cek_email = $this->second_db->withquery("select * from calon_siswa_sd where email = ".$this->db->escape($this->post("email")), "row");
          if(!empty($cek_email)){
