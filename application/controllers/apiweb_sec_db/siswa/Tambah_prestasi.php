...
class Tambah_prestasi extends REST_Controller {
    ...
    function index_post() {
      ...
      if (!empty($data)) {
        if($jenjang=='sd'){
          $insert=$this->second_db->insertid("prestasi_siswa_sd",$data);
        }elseif($jenjang=='smp'){
          $insert=$this->second_db->insertid("prestasi_siswa_smp",$data);
        }elseif($jenjang=='sma'){
          $insert=$this->second_db->insertid("prestasi_siswa_sma",$data);
        }else{
          $insert=$this->second_db->insertid("prestasi_siswa_ft",$data);
        }
        if($insert){
