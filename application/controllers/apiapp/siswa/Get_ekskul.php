    ...
    public function index_post()
    {
        ...
        if (!empty($jenjang)) {
            if ($jenjang == "ft") {
                ...
                $data = $this->mymodel->withquery("select e.* from ekskul e where e.jenjang = '".$jenjang."' and tahun_ajaran_aktif != '' and tahun_ajaran_aktif = '".$get_tahun_ajaran."' order by e.semester_aktif DESC, e.nama ASC", "result");
            }
        }
        else{
