...
<section class="content-header">
    <h1>
        Manajemen Tagihan SMA        <small><?= cclang('new', ['Manajemen Tagihan SMA']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Manajemen Tagihan SMA']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_tingkatan" id="id_tingkatan" data-placeholder="Select Tingkatan" >
                                    ...
                                    <option value="<?= $row->id_tingkatan_sma ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="id_kelas[]" id="id_kelas" data-placeholder="Select Kelas" multiple >
                                    ...
                                    <option value="<?= $row->id_kelas_sma ?>"><?= $row->nama_kelas; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/transaksi_lain_sma_manajemen/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
