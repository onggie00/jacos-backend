...
<section class="content-header">
    <h1>
        Rapor SMA        <small>Edit Rapor SMA</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Rapor SMA</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/siswa_sma_aktif_raport/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nis" id="nis" placeholder="NIS" value="<?= set_value('nis', $siswa_sma_aktif_raport->nis); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?= set_value('nama_lengkap', $siswa_sma_aktif_raport->nama_lengkap); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_aktif" id="id_siswa_aktif" data-placeholder="Select Detail Siswa" >
                                    ...
                                    <option <?=  $row->id_siswa_sma_aktif ==  $siswa_sma_aktif_raport->id_siswa_aktif ? 'selected' : ''; ?> value="<?= $row->id_siswa_sma_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tahun_ajaran" id="tahun_ajaran" placeholder="Tahun Ajaran" value="<?= set_value('tahun_ajaran', $siswa_sma_aktif_raport->tahun_ajaran); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jenis_ujian" id="jenis_ujian" placeholder="Nama Ujian" value="<?= set_value('jenis_ujian', $siswa_sma_aktif_raport->jenis_ujian); ?>">
                                <small class="info help-block">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_sync_valid"  placeholder="Tanggal Sync SPP" id="tanggal_sync_valid" value="<?= set_value('siswa_sma_aktif_raport_tanggal_sync_valid_name', $siswa_sma_aktif_raport->tanggal_sync_valid); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siswa_sma_aktif_raport_file_raport_uuid" id="siswa_sma_aktif_raport_file_raport_uuid" type="hidden" value="<?= set_value('siswa_sma_aktif_raport_file_raport_uuid'); ?>">
                                <input class="data_file" name="siswa_sma_aktif_raport_file_raport_name" id="siswa_sma_aktif_raport_file_raport_name" type="hidden" value="<?= set_value('siswa_sma_aktif_raport_file_raport_name', $siswa_sma_aktif_raport->file_raport); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_siswa_sma_aktif_raport.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#siswa_sma_aktif_raport_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#siswa_sma_aktif_raport_file_raport_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/siswa_sma_aktif_raport/get_file_raport_file/<?= $siswa_sma_aktif_raport->id; ?>',
