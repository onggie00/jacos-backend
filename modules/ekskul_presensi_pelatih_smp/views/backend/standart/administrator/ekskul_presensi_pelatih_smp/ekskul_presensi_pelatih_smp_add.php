...
<section class="content-header">
    <h1>
        Presensi Pelatih  SMP        <small><?= cclang('new', ['Presensi Pelatih  SMP']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Presensi Pelatih  SMP']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_pelatih" id="id_pelatih" data-placeholder="Select Pelatih" >
                                    ...
                                    <option value="<?= $row->id_manajemen ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_presensi_pelatih_smp/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
