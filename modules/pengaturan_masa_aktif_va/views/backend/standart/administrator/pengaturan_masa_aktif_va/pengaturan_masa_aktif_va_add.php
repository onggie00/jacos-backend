...
<section class="content-header">
    <h1>
        Pengaturan Masa Aktif Va        <small><?= cclang('new', ['Pengaturan Masa Aktif Va']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pengaturan Masa Aktif Va']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="value" id="value" placeholder="Value" value="<?= set_value('value'); ?>">
                                <small class="info help-block">
                                <b>Input Value</b> Max Length : 11.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="tipe_date" value="day"> hari                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="tipe_date" value="hour"> jam                                    </label>
                                    </div>
                                    </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pengaturan_masa_aktif_va/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
