...
class Get_jadwal_ekskul extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        $data = $this->mymodel->withquery("select e.nama as nama_ekskul, e.hari, e.jam, m.* from ekskul_member_".$jenjang." m join ekskul e on m.id_ekskul = e.id_ekskul and m.tahun_ajaran = e.tahun_ajaran_aktif and m.semester = e.semester_aktif where m.id_siswa = '".$id_siswa."' order by m.status_member ASC, m.joined_date ASC", "result");
