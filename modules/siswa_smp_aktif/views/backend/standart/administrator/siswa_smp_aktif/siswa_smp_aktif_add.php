...
<section class="content-header">
    <h1>
        Siswa Smp Aktif        <small><?= cclang('new', ['Siswa Smp Aktif']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa Smp Aktif']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                         ...
                         <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_smp" id="id_siswa_smp" data-placeholder="Select Id Siswa Smp" >
                                    ...
                                    <option value="<?= $row->id_siswa_smp ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="spp_custom" id="spp_custom" placeholder="SPP Khusus" value="0"
                                ...
                                document.getElementById('frm_siswa_smp_aktif_add') || document.addEventListener('DOMContentLoaded', function() {
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa_smp_aktif/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
      ...
      $('#id_tahun_ajaran').change(function(event) {
        ...
        .done(function(res) {
            ...
            $.each(res, function(index, val) {
                html += '<option value="'+val.id_tahun_ajaran+'">'+val.label+'</option>'
            });
      ...
      $('#id_siswa_smp').change(function(event) {
        ...
        .done(function(res) {
            var html = '<option value=""></option>';
            $.each(res, function(index, val) {
                html += '<option value="'+val.id_siswa_smp+'">'+val.nama_lengkap+'</option>'
            });
