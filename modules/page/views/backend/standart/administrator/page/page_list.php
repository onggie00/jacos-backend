...
<section class="content-header">
   <h1>
      Page<small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', 'Page'); ?> (Ctrl+a)" href="<?=  site_url('administrator/page/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', 'Page'); ?></a>
                        <?php }) ?>
                        <?php is_allowed('page_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', 'Page'); ?>" href="<?= site_url('administrator/page/export'); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export', 'Page'); ?></a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_page" id="form_page" action="<?= base_url('administrator/page/index'); ?>">
                     ...
                     <?php foreach($pages as $page): ?>
                        <tr>
                           ...
                           <td>
                            <?php 
                              if ($page->type == 'backend') {
                                $view_url = 'administrator/page/detail/'.$page->link;
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/page/edit/' . $page->id); ?>" class="label-default"><i class="fa fa-edit "></i> <?= cclang('update_button'); ?></a>
                              <?php }) ?>
                              <?php is_allowed('page_delete', function() use ($page){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/page/delete/' . $page->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> <?= cclang('remove_button'); ?></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/page');?>" title="<?= cclang('reset_filter'); ?>">
     ...
     $('#apply').click(function() {
         ...
         if (bulk.val() == 'delete') {
             swal({
                 ...
                 function(isConfirm) {
                     if (isConfirm) {
                         document.location.href = BASE_URL + '/administrator/page/delete?' + serialize_bulk;
                     }
                 });
