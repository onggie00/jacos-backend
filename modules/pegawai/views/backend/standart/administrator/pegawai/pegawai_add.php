                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kk" id="kk" placeholder="Kk" value="<?= set_value('kk'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="jenis_kelamin" id="jenis_kelamin" data-placeholder="Select Jenis Kelamin" >
                                    <option value=""></option>
                                    <option value="L">Lak-laki</option>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_posisi" id="id_posisi" data-placeholder="Select Id Posisi" >
                                    ...
                                    <option value="<?= $row->id_posisi ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="pegawai_foto_profil_uuid" id="pegawai_foto_profil_uuid" type="hidden" value="<?= set_value('pegawai_foto_profil_uuid'); ?>">
                                <input class="data_file" name="pegawai_foto_profil_name" id="pegawai_foto_profil_name" type="hidden" value="<?= set_value('pegawai_foto_profil_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="pegawai_slip_gaji_uuid" id="pegawai_slip_gaji_uuid" type="hidden" value="<?= set_value('pegawai_slip_gaji_uuid'); ?>">
                                <input class="data_file" name="pegawai_slip_gaji_name" id="pegawai_slip_gaji_name" type="hidden" value="<?= set_value('pegawai_slip_gaji_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          ...
          if(res.success) {
            var id_foto_profil = $('#pegawai_foto_profil_galery').find('li').attr('qq-file-id');
            var id_slip_gaji = $('#pegawai_slip_gaji_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_foto_profil !== 'undefined') {
                    $('#pegawai_foto_profil_galery').fineUploader('deleteFile', id_foto_profil);
                }
            if (typeof id_slip_gaji !== 'undefined') {
                    $('#pegawai_slip_gaji_galery').fineUploader('deleteFile', id_slip_gaji);
                }
