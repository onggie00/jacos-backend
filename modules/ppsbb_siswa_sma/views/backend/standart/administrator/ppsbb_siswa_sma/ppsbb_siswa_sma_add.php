...
<section class="content-header">
    <h1>
        PPSBB Siswa SMA        <small><?= cclang('new', ['PPSBB Siswa SMA']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['PPSBB Siswa SMA']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="ppsbb_siswa_sma_sertifikat_uuid" id="ppsbb_siswa_sma_sertifikat_uuid" type="hidden" value="<?= set_value('ppsbb_siswa_sma_sertifikat_uuid'); ?>">
                                <input class="data_file" name="ppsbb_siswa_sma_sertifikat_name" id="ppsbb_siswa_sma_sertifikat_name" type="hidden" value="<?= set_value('ppsbb_siswa_sma_sertifikat_name'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="jenis_lomba" id="jenis_lomba" data-placeholder="Select Jenis Lomba" >
                                    ...
                                    <option value="<?= $row->id_jenis_lomba ?>"><?= $row->jenis_lomba; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ppsbb_siswa_sma/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_sertifikat = $('#ppsbb_siswa_sma_sertifikat_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_sertifikat !== 'undefined') {
                    $('#ppsbb_siswa_sma_sertifikat_galery').fineUploader('deleteFile', id_sertifikat);
                }
