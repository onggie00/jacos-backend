...
<section class="content-header">
    <h1>
        Siswa France Track <small>Edit Siswa France Track</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Siswa France Track</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/siswa_ft/edit_save/' . $this->uri->segment(4)), [
                            'name'    => 'form_siswa_ft',
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="nama_lengkap" name="nama_lengkap" rows="5" class="textarea form-control"><?= set_value('nama_lengkap', $siswa_ft->nama_lengkap); ?></textarea>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="<?= set_value('email', $siswa_ft->email); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="email_ms_office" id="email_ms_office" placeholder="Email Ms. Office" value="<?= set_value('email_ms_office', $siswa_ft->email_ms_office); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nisn" id="nisn" placeholder="NISN" value="<?= set_value('nisn', $siswa_ft->nisn); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" placeholder="Tempat Lahir" value="<?= set_value('tempat_lahir', $siswa_ft->tempat_lahir); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="tgl_lahir" placeholder="Tanggal Lahir" id="tgl_lahir" value="<?= set_value('siswa_ft_tgl_lahir_name', $siswa_ft->tgl_lahir); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <div class="col-md-3 padding-left-0">
                                    <label>
                                        <input <?= $siswa_ft->jenis_kelamin == "Laki-laki" ? "checked" : ""; ?> type="radio" class="flat-red" name="jenis_kelamin" value="Laki-laki"> laki-laki </label>
                                </div>
                                <div class="col-md-3 padding-left-0">
                                    <label>
                                        <input <?= $siswa_ft->jenis_kelamin == "Perempuan" ? "checked" : ""; ?> type="radio" class="flat-red" name="jenis_kelamin" value="Perempuan"> perempuan </label>
                                </div>
                                </select>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="agama" id="agama" placeholder="Agama" value="<?= set_value('agama', $siswa_ft->agama); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="email_ms_office_ortu" id="email_ms_office_ortu" placeholder="Email Ms. Office Ortu" value="<?= set_value('email_ms_office_ortu', $siswa_ft->email_ms_office_ortu); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" placeholder="Nama Ibu" value="<?= set_value('nama_ibu', $siswa_ft->nama_ibu); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pekerjaan_ibu" id="pekerjaan_ibu" placeholder="Pekerjaan Ibu" value="<?= set_value('pekerjaan_ibu', $siswa_ft->pekerjaan_ibu); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="notelp_ibu" id="notelp_ibu" placeholder="No. Telepon Ibu" value="<?= set_value('notelp_ibu', $siswa_ft->notelp_ibu); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" placeholder="Nama Ayah" value="<?= set_value('nama_ayah', $siswa_ft->nama_ayah); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pekerjaan_ayah" id="pekerjaan_ayah" placeholder="Pekerjaan Ayah" value="<?= set_value('pekerjaan_ayah', $siswa_ft->pekerjaan_ayah); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="notelp_ayah" id="notelp_ayah" placeholder="No. Telepon Ayah" value="<?= set_value('notelp_ayah', $siswa_ft->notelp_ayah); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="alamat" name="alamat" rows="5" class="textarea form-control"><?= set_value('alamat', $siswa_ft->alamat); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="kelurahan" id="kelurahan" data-placeholder="Select Kelurahan">
                                    ...
                                    <?php foreach (db_get_all_data('areas') as $row) : ?>
                                        <option <?= $row->id ==  $siswa_ft->kelurahan ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="kecamatan" id="kecamatan" data-placeholder="Select Kecamatan">
                                    ...
                                    <?php foreach (db_get_all_data('districts') as $row) : ?>
                                        <option <?= $row->id ==  $siswa_ft->kecamatan ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="kota" id="kota" data-placeholder="Select Kota">
                                    ...
                                    <?php foreach (db_get_all_data('regencies') as $row) : ?>
                                        <option <?= $row->id ==  $siswa_ft->kota ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="provinsi" id="provinsi" data-placeholder="Select Provinsi">
                                    ...
                                    <?php foreach (db_get_all_data('provinces') as $row) : ?>
                                        <option <?= $row->id ==  $siswa_ft->provinsi ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_pos" id="kode_pos" placeholder="Kode Pos" value="<?= set_value('kode_pos', $siswa_ft->kode_pos); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="sekolah_asal" name="sekolah_asal" rows="5" class="textarea form-control"><?= set_value('sekolah_asal', $siswa_ft->sekolah_asal); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siswa_ft_foto_peserta_uuid" id="siswa_ft_foto_peserta_uuid" type="hidden" value="<?= set_value('siswa_ft_foto_peserta_uuid'); ?>">
                                <input class="data_file" name="siswa_ft_foto_peserta_name" id="siswa_ft_foto_peserta_name" type="hidden" value="<?= set_value('siswa_ft_foto_peserta_name', $siswa_ft->foto_peserta); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siswa_ft_akte_lahir_uuid" id="siswa_ft_akte_lahir_uuid" type="hidden" value="<?= set_value('siswa_ft_akte_lahir_uuid'); ?>">
                                <input class="data_file" name="siswa_ft_akte_lahir_name" id="siswa_ft_akte_lahir_name" type="hidden" value="<?= set_value('siswa_ft_akte_lahir_name', $siswa_ft->akte_lahir); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siswa_ft_kartu_keluarga_uuid" id="siswa_ft_kartu_keluarga_uuid" type="hidden" value="<?= set_value('siswa_ft_kartu_keluarga_uuid'); ?>">
                                <input class="data_file" name="siswa_ft_kartu_keluarga_name" id="siswa_ft_kartu_keluarga_name" type="hidden" value="<?= set_value('siswa_ft_kartu_keluarga_name', $siswa_ft->kartu_keluarga); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sumber_informasi" id="sumber_informasi" placeholder="Sumber Informasi" value="<?= set_value('sumber_informasi', $siswa_ft->sumber_informasi); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="alasan_tertarik" id="alasan_tertarik" placeholder="Alasan Tertarik" value="<?= set_value('alasan_tertarik', $siswa_ft->alasan_tertarik); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="peminatan_ft" id="peminatan_ft" data-placeholder="Select Peminatan">
                                    ...
                                    <?php foreach (db_get_all_data('peminatan_ft') as $row) : ?>
                                        <option <?= $row->id_peminatan_ft ==  $siswa_ft->peminatan_ft ? 'selected' : ''; ?> value="<?= $row->id_peminatan_ft ?>"><?= $row->peminatan; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="status_lulus" id="status_lulus" data-placeholder="Select Status Lulus">
                                    ...
                                    <?php foreach (db_get_all_data('status_lulus') as $row) : ?>
                                        <option <?= $row->id_status_lulus ==  $siswa_ft->status_lulus ? 'selected' : ''; ?> value="<?= $row->id_status_lulus ?>"><?= $row->status_lulus; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_transaksi" id="no_transaksi" placeholder="Nomor Transaksi" value="<?= set_value('no_transaksi', $siswa_ft->no_transaksi); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_peserta" id="no_peserta" placeholder="Nomor Peserta" value="<?= set_value('no_peserta', $siswa_ft->no_peserta); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="va_number" id="va_number" placeholder="Virtual Account" value="<?= set_value('va_number', $siswa_ft->va_number); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tahun_ajaran" id="tahun_ajaran" placeholder="Tahun Ajaran" value="<?= set_value('tahun_ajaran', $siswa_ft->tahun_ajaran); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="gelombang" id="gelombang" placeholder="Gelombang" value="<?= set_value('tahun_ajaran', $siswa_ft->gelombang); ?>">
                                <small class="info help-block text-danger">
                                    *Periode Gelombang
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            <label for="is_show" class="col-sm-2 control-label">Tampilkan data
                            </label>
                            <div class="col-sm-8">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                ...
                .done(function(res) {
                    ...
                    if (res.success) {
                        var id = $('#siswa_ft_image_galery').find('li').attr('qq-file-id');
                        if (save_type == 'back') {
        ...
        $('#siswa_ft_foto_peserta_galery').fineUploader({
            ...
            session: {
                endpoint: BASE_URL + 'administrator/siswa_ft/get_foto_peserta_file/<?= $siswa_ft->id_siswa_ft; ?>',
        ...
        $('#siswa_ft_akte_lahir_galery').fineUploader({
            ...
            session: {
                endpoint: BASE_URL + 'administrator/siswa_ft/get_akte_lahir_file/<?= $siswa_ft->id_siswa_ft; ?>',
                refreshOnRequest: true
            },
            multiple: false,
            validation: {
        ...
        $('#siswa_ft_kartu_keluarga_galery').fineUploader({
            ...
            session: {
                endpoint: BASE_URL + 'administrator/siswa_ft/get_kartu_keluarga_file/<?= $siswa_ft->id_siswa_ft; ?>',
                refreshOnRequest: true
            },
            multiple: false,
            validation: {
