...
<section class="content-header">
    <h1>
        Prestasi Guru Sma        <small><?= cclang('new', ['Prestasi Guru Sma']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Prestasi Guru Sma']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="prestasi_guru_sma_file_prestasi_uuid" id="prestasi_guru_sma_file_prestasi_uuid" type="hidden" value="<?= set_value('prestasi_guru_sma_file_prestasi_uuid'); ?>">
                                <input class="data_file" name="prestasi_guru_sma_file_prestasi_name" id="prestasi_guru_sma_file_prestasi_name" type="hidden" value="<?= set_value('prestasi_guru_sma_file_prestasi_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="prestasi_guru_sma_foto_prestasi_uuid" id="prestasi_guru_sma_foto_prestasi_uuid" type="hidden" value="<?= set_value('prestasi_guru_sma_foto_prestasi_uuid'); ?>">
                                <input class="data_file" name="prestasi_guru_sma_foto_prestasi_name" id="prestasi_guru_sma_foto_prestasi_name" type="hidden" value="<?= set_value('prestasi_guru_sma_foto_prestasi_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/prestasi_guru_sma/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_file_prestasi = $('#prestasi_guru_sma_file_prestasi_galery').find('li').attr('qq-file-id');
            var id_foto_prestasi = $('#prestasi_guru_sma_foto_prestasi_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_prestasi !== 'undefined') {
                    $('#prestasi_guru_sma_file_prestasi_galery').fineUploader('deleteFile', id_file_prestasi);
                }
            if (typeof id_foto_prestasi !== 'undefined') {
                    $('#prestasi_guru_sma_foto_prestasi_galery').fineUploader('deleteFile', id_foto_prestasi);
                }
