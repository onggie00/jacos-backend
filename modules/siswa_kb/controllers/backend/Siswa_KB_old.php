 ...
 *|
 */
class Siswa_kb_old extends Admin
{
	...
	public function index($offset = 0)
	{
		...
		$this->data['siswa_kbs'] = $this->model_siswa_kb->get($filter, $field, $this->limit_page, $offset, [], $sort, $sort_type);
	...
	public function edit_save($id)
	{
		...
		if ($this->form_validation->run()) {
			...
			if (!empty($save_siswa_kb) && $save_data['status_lulus'] == "2") {
				...
				// 	$this->mymodel->update("siswa_kb", array("no_transaksi" => $no_transaksi), "id_siswa_kb", $id);
	...
	public function export()
	{
		...
		$this->model_siswa_kb->export_siswa('siswa_kb', 'siswa_kb');
	}
