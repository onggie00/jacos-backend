...
class Export_pdf_siswa extends MY_Controller {
    ...
    public function index()
    {
      ...
      if(isset($headers['user_role']))
        ...
        $get_ruang = $this->mymodel->withquery("select u.id_ruang_pendaftaran, u.lokasi_ujian, u.nama_ruang, u.meeting_id, u.meeting_url, u.meeting_password, u.maks_peserta from ujian_ruang_pendaftaran_ft u 
        ...
        if($tipe_siswa=="ft"){
          ...
          $datas['title'] = "JADWAL READINESS OF LEARNING OBSERVATION (ROLE)";
          $datas['title_simulasi'] = "PELAKSANAAN SIMULASI";
        }
