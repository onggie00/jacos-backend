...
class Cc_App
{
	...
	{
		// ponytail: cookie cache 'options' dihapus — cc_options ikut terkirim sebagai
		// Set-Cookie tiap request, membengkakkan response header (Apigee BRI tolak:
		// protocol.http.TooBigHeaders 25.600 bytes). Baca DB tiap request, tabel kecil.
