...
<section class="content-header">
   <h1>
      Pramubhakti      <small><?= cclang('detail', ['Pramubhakti']); ?> </small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Detail Pramubhakti</h5>
                     <hr>
                  </div>

                 
                  <div class="form-horizontal" name="form_pramubhakti" id="form_pramubhakti" >
                   
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Id Pramubhakti </label>

                        <div class="col-sm-8">
                           <?= _ent($pramubhakti->id_pramubhakti); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($pramubhakti->status_kepegawaian); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($pramubhakti->token_expired); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($pramubhakti->email_ms_office); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($pramubhakti->presensi_role); ?>
                        </div>
                    </div>
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit pramubhakti (Ctrl+e)" href="<?= site_url('administrator/pramubhakti/edit/'.$pramubhakti->id_pramubhakti); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Pramubhakti']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/pramubhakti/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Pramubhakti']); ?></a>
                     </div>
