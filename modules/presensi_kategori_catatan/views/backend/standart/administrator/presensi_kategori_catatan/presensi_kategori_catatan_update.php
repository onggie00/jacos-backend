...
<section class="content-header">
    <h1>
        <?= cclang('presensi_kategori_catatan'); ?> <small><?= cclang('edit', cclang('presensi_kategori_catatan')); ?></small>
    </h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header">
                            <div class="widget-user-image">
                                <img class="img-circle" src="<?= BASE_ASSET; ?>/img/edit.png" alt="User Avatar">
                            </div>
                            <h3 class="widget-user-username"><?= cclang('presensi_kategori_catatan'); ?></h3>
                            <h5 class="widget-user-desc"><?= cclang('edit', cclang('presensi_kategori_catatan')); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', array(
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" placeholder="Nama Kategori" value="<?= set_value('nama_kategori', $presensi_kategori_catatan->nama_kategori); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" min="0" class="form-control" name="skor" id="skor" placeholder="0" value="<?= set_value('skor', (int)$presensi_kategori_catatan->skor); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_custom" id="is_custom" value="1" <?= set_checkbox('is_custom', '1', ((int)$presensi_kategori_catatan->is_custom === 1)); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="status" id="status">
                                    <option value="aktif" <?= set_select('status', 'aktif', $presensi_kategori_catatan->status === 'aktif'); ?>>Aktif</option>
                                    <option value="nonaktif" <?= set_select('status', 'nonaktif', $presensi_kategori_catatan->status === 'nonaktif'); ?>>Nonaktif</option>
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(){
    ...
    $('.btn_save').click(function(){
        ...
        $.ajax({
            url: BASE_URL + '/administrator/presensi_kategori_catatan/edit_save/<?= $presensi_kategori_catatan->id_kategori_catatan; ?>',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
