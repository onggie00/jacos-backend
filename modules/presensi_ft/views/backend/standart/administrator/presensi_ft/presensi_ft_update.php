...
<section class="content-header">
    <h1>
        Presensi FT        <small>Edit Presensi FT</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Presensi FT</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/presensi_ft/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_aktif" id="id_siswa_aktif" data-placeholder="Select Siswa Aktif" >
                                    ...
                                    <option <?=  $row->id_siswa_ft_aktif ==  $presensi_ft->id_siswa_aktif ? 'selected' : ''; ?> value="<?= $row->id_siswa_ft_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="wifi_ssid" id="wifi_ssid" data-placeholder="Select WIFI SSID" >
                                    ...
                                    <option <?=  $row->nama_ssid ==  $presensi_ft->wifi_ssid ? 'selected' : ''; ?> value="<?= $row->nama_ssid ?>"><?= $row->nama_ssid; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="wifi_ip" id="wifi_ip" placeholder="IP" value="<?= set_value('wifi_ip', $presensi_ft->wifi_ip); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="hari_absen" id="hari_absen" placeholder="Hari Presensi" value="<?= set_value('hari_absen', $presensi_ft->hari_absen); ?>">
                                <small class="info help-block">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right timepicker" name="waktu_absen" id="waktu_absen" value="<?= set_value('presensi_ft_waktu_absen_name', $presensi_ft->waktu_absen); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_absen"  placeholder="Tanggal Presensi" id="tanggal_absen" value="<?= set_value('presensi_ft_tanggal_absen_name', $presensi_ft->tanggal_absen); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="status_absen" id="status_absen" placeholder="Status Presensi" value="<?= set_value('status_absen', $presensi_ft->status_absen); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="alasan_terlambat" id="alasan_terlambat" placeholder="Alasan Keterlambatan" value="<?= set_value('alasan_terlambat', $presensi_ft->alasan_terlambat); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_izin" id="id_izin" data-placeholder="Select Izin" >
                                    ...
                                    <option <?=  $row->id ==  $presensi_ft->id_izin ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->jenis_izin; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_presensi_ft.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#presensi_ft_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
