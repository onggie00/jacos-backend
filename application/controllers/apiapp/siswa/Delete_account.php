    ...
    public function index_post()
    {
      ...
      foreach (getallheaders() as $name => $value) {
        ...
        if (!empty($id_siswa_aktif)) {
          ...
          $update_data_aktif = $this->mymodel->update("siswa_".$jenjang."_aktif", array("deleted_at" => $date), "id_siswa_".$jenjang."_aktif", $id_siswa_aktif);
          $update_data_siswa = $this->mymodel->update("siswa_".$jenjang, array("deleted_at" => $date, "token" => null), "id_siswa_".$jenjang, $get_siswa_aktif->id_siswa);
