...
<head>
	...
	<title>SLIP <?= strtoupper($slip->nama_slip); ?></title>
</head>
	...
	<?php $tahun_ajaran = $rapor->tahun_ajaran; ?>
        <table border="0">
            <tr>
                ...
                <td style="width: 350;text-align:center;"> <?php echo strtoupper($slip->nama_slip); ?></td>
                <td style="width: 110;">No. KWITANSI : </td>
                <td style="width: 80;text-align:right"><?php echo $slip->kwitansi; ?></td>
            </tr>
        </table>
        ...
        <table border="0" cellspacing="0" style="margin-left:0px;margin-top: 10px;">
            <tr>
                ...
                <td style="width: 20;">Rp </td>
                <td style="width: 70; text-align: right;"><?= format_nominal($slip->total_penghasilan); ?></td>
                <td style="width: 110">&nbsp;</td>
                <td style="width: 170; text-align: left;">B. Total Potongan</td>
                <td style="width: 20;">Rp </td>
                <td style="width: 100; text-align: right;"><?= format_nominal($slip->total_potongan); ?></td>
            </tr>
        </table>
        ...
        <table border="0" cellspacing="0" style="margin-top: 20px;">
            <tr>
                ...
                <td style="width: 20;">Rp </td>
                <td style="width: 70;text-align: right;"><?= format_nominal($slip->total_diterima); ?></td>
                <td style="width: 110">&nbsp;</td>
