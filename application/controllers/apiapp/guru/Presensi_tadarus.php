...
/**
 * --------------------------------------------------------------------------
 * Presensi Tadarus — Simpan Batch
 * --------------------------------------------------------------------------
 * POST /apiapp/guru/presensi_tadarus
    ...
    public function index_post()
    {
        ...
        foreach ($siswa_data as $s) {
            ...
            $save_data = array(
                ...
                'kehadiran'      => ($status_hadir === 'Izin' || $status_hadir === 'Sakit') ? 2 : $kehadiran,
                'kelengkapan'    => ($status_hadir === 'Izin' || $status_hadir === 'Sakit') ? 2 : $kelengkapan,
                'adab'           => ($status_hadir === 'Izin' || $status_hadir === 'Sakit') ? 2 : $adab,
                'keaktifan'      => ($status_hadir === 'Izin' || $status_hadir === 'Sakit') ? 2 : $keaktifan,
                'total_nilai'    => ($status_hadir === 'Izin' || $status_hadir === 'Sakit') ? '50.00' : $total_nilai,
