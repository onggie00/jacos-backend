...
<section class="content-header">
    <h1>
        Mailbox Recipient        <small><?= cclang('new', ['Mailbox Recipient']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Mailbox Recipient']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_mail" id="id_mail" data-placeholder="Select Mail" >
                                    ...
                                    <option value="<?= $row->id_mail ?>"><?= $row->mailbox_title; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Name" value="<?= set_value('nama_lengkap'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="is_read" value="0"> Delivered                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="is_read" value="1"> Read                                    </label>
                                    </div>
                                    </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/mailbox_recipient/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
