    ...
    public function index_post()
    {
      ...
      if(isset($headers['x-token']))
        ...
        if (empty($cek_email)) {
          ...
          if (!empty($data)) {
            $id_siswa = $this->second_db->insertid("siswa_sd",$data);
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->second_db->withquery("select va_number_bri, id_siswa_sd as id_siswa from calon_siswa_sd where va_number_bri like '".$this->db->escape_like_str($brivaNo.date('y', strtotime('+1 years')))."01%' and va_number_bri != '' and is_mutasi = '1' order by id_siswa_sd DESC","row");
                ...
                $id_transaksi = $this->second_db->insertid("transaksi",$data_transaksi);
                $this->second_db->update("siswa_sd", array("no_transaksi" => $no_transaksi, "va_number_bri" => $va_number_bri), "id_siswa_sd", $id_siswa);
