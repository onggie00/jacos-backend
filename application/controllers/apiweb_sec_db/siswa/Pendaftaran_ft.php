    ...
    public function index_post()
    {
      ...
      if(isset($headers['x-token']))
        ...
        $sekolah_asal = "";
          ...
          //cek email duplicate
          $cek_email = $this->second_db->withquery("select * from siswa_ft where email = '".$this->post("email")."'", "row");
          if(!empty($cek_email)){
            ...
            $id_siswa = $this->second_db->insertid("siswa_ft",$data);
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->second_db->withquery("select va_number, id_siswa_ft as id_siswa from siswa_ft where va_number like '".$prefix.$client_id.date('y', strtotime('+1 years'))."09%' and va_number != '' order by id_siswa_ft DESC","row");
                ...
                $this->second_db->update("siswa_ft", array("no_transaksi" => $no_transaksi, "va_number" => $va_number), "id_siswa_ft", $id_siswa);
