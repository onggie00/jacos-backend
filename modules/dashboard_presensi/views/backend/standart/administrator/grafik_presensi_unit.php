        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Presensi per Unit</h3>
            ...
            <div class="box-body chart-responsive">
              ...
              <div class="row">
                <div class="chart" id="chart-presensi-unit" style="height: 200px;"></div>
              </div>
              <div class="row">
  ...
  let chart = new Morris.Bar({
    ...
    resize: true
        ...
        $('#btn_filter').click(function () {
            ...
            $.ajax({
                url: '<?= site_url('administrator/dashboard_presensi/chart_presensi_unit') ?>',
                method: 'POST',
                data: { start_date: start, end_date: end , unit: unit },
                dataType: 'json',
