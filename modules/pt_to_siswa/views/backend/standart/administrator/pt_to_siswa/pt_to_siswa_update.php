...
<section class="content-header">
    <h1>
        UTBK Siswa        <small>Edit UTBK Siswa</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit UTBK Siswa</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/pt_to_siswa/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="jenjang" id="jenjang" data-placeholder="Select Jenjang" >
                                    <option value=""></option>
                                    <option <?= $pt_to_siswa->jenjang == "ft" ? 'selected' :''; ?> value="ft">FT</option>
                                    <option <?= $pt_to_siswa->jenjang == "sma" ? 'selected' :''; ?> value="sma">SMA</option>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_aktif" id="id_siswa_aktif" data-placeholder="Select Siswa" >
                                    ...
                                    <option <?=  $row->id_siswa_ft_aktif ==  $pt_to_siswa->id_siswa_aktif ? 'selected' : ''; ?> value="<?= $row->id_siswa_ft_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_kelas" id="id_kelas" data-placeholder="Select Kelas" >
                                    ...
                                    <option <?=  $row->id_kelas_ft ==  $pt_to_siswa->id_kelas ? 'selected' : ''; ?> value="<?= $row->id_kelas_ft ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nilai_utbk1" id="nilai_utbk1" placeholder="Nilai UTBK 1" value="<?= set_value('nilai_utbk1', $pt_to_siswa->nilai_utbk1); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nilai_utbk2" id="nilai_utbk2" placeholder="Nilai UTBK 2" value="<?= set_value('nilai_utbk2', $pt_to_siswa->nilai_utbk2); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nilai_utbk3" id="nilai_utbk3" placeholder="Nilai UTBK 3" value="<?= set_value('nilai_utbk3', $pt_to_siswa->nilai_utbk3); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nilai_utbk4" id="nilai_utbk4" placeholder="Nilai UTBK 4" value="<?= set_value('nilai_utbk4', $pt_to_siswa->nilai_utbk4); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nilai_nasional" id="nilai_nasional" placeholder="Nilai Nasional" value="<?= set_value('nilai_nasional', $pt_to_siswa->nilai_nasional); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_pt_to_siswa.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#pt_to_siswa_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
