...
<section class="content-header">
    <h1>
        Ruang Kelas        <small><?= cclang('new', ['Ruang Kelas']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Ruang Kelas']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kapasitas" id="kapasitas" placeholder="Kapasitas" value="<?= set_value('kapasitas'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kelas" id="kelas" placeholder="Kelas" value="<?= set_value('kelas'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomor_peserta_awal" id="nomor_peserta_awal" placeholder="Nomor Peserta Awal" value="<?= set_value('nomor_peserta_awal'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomor_peserta_akhir" id="nomor_peserta_akhir" placeholder="Nomor Peserta Akhir" value="<?= set_value('nomor_peserta_akhir'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ujian_ruang_kelas/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
