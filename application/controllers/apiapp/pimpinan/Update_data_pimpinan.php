...
class Update_data_pimpinan extends REST_Controller
{
  ...
  function index_post()
  {
    ...
    $id = $this->post('id_pimpinan');
    $jenjang = $this->post('jenjang');

    if($jenjang=='sd'){
      $pimpinan="pimpinan_sd";
      $pimpinan="pimpinan_sd";
    }elseif($jenjang=='smp'){
      $pimpinan="pimpinan_smp";
      $pimpinan="pimpinan_smp";
    }elseif($jenjang=='sma'){
      $pimpinan="pimpinan_sma";
      $pimpinan="pimpinan_sma";
    }else{
      $pimpinan="pimpinan_ft";
      $pimpinan="pimpinan_ft";
    }
    ...
    if (!empty($data)) {
      $update_pimpinan = $this->mymodel->update($pimpinan, $data, "id_pimpinan", $id);
    }

    if ($update_pimpinan == -1) {
