...
<section class="content-header">
    <h1>
        Anggota Ekskul SMA        <small>Edit Anggota Ekskul SMA</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Anggota Ekskul SMA</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/ekskul_member_sma/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_ekskul" id="id_ekskul" data-placeholder="Select Ekstrakurikuler" >
                                    ...
                                    <option <?=  $row->id_ekskul ==  $ekskul_member_sma->id_ekskul ? 'selected' : ''; ?> value="<?= $row->id_ekskul ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa" id="id_siswa" data-placeholder="Select Siswa" >
                                    ...
                                    <option <?=  $row->id_siswa_sma_aktif ==  $ekskul_member_sma->id_siswa ? 'selected' : ''; ?> value="<?= $row->id_siswa_sma_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="ekskul_member_sma_file_pembayaran_uuid" id="ekskul_member_sma_file_pembayaran_uuid" type="hidden" value="<?= set_value('ekskul_member_sma_file_pembayaran_uuid'); ?>">
                                <input class="data_file" name="ekskul_member_sma_file_pembayaran_name" id="ekskul_member_sma_file_pembayaran_name" type="hidden" value="<?= set_value('ekskul_member_sma_file_pembayaran_name', $ekskul_member_sma->file_pembayaran); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="status_member" id="status_member" data-placeholder="Select Status" >
                                    <option value=""></option>
                                    <option <?= $ekskul_member_sma->status_member == "0" ? 'selected' :''; ?> value="0">Tidak Aktif</option>
                                    <option <?= $ekskul_member_sma->status_member == "1" ? 'selected' :''; ?> value="1">Aktif</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tahun_ajaran" id="tahun_ajaran" placeholder="<?= date('Y')."/".(date('Y', strtotime('+1 year'))); ?>" value="<?= $ekskul_member_sma->tahun_ajaran; ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="semester" id="semester" placeholder="1 = Ganjil, 2 = Genap" value="<?= $ekskul_member_sma->semester; ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_ekskul_member_sma.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#ekskul_member_sma_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#ekskul_member_sma_file_pembayaran_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/ekskul_member_sma/get_file_pembayaran_file/<?= $ekskul_member_sma->id_member; ?>',
