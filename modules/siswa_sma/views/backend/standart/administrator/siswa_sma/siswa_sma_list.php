...
<section class="content-header">
   <h1>
      <i class="fa fa-users"></i> <?= cclang('siswa_sma') ?> <small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><?= cclang('siswa_sma') ?></li>
   </ol>
</section>
      ...
      <div class="col-md-12">
         ...
         <div class="box box-warning">
            <div class="box-header with-border">
               <h3 class="box-title">
                  <i class="fa fa-graduation-cap"></i> Data Siswa SMA
                  <span class="label bg-yellow" style="margin-left:10px"><?= $siswa_sma_counts; ?> Data</span>
               </h3>
               <div class="box-tools pull-right">
                  <?php is_allowed('siswa_sma_add', function () { ?>
                     <a class="btn btn-sm btn-success" title="Tambah Siswa (Ctrl+a)" href="<?= site_url('administrator/siswa_sma/add'); ?>"><i class="fa fa-plus"></i> Tambah</a>
                  <?php }) ?>
                  <?php is_allowed('siswa_sma_export', function () { ?>
                     <a class="btn btn-sm btn-success" title="Export XLS" href="<?= site_url('administrator/siswa_sma/export?' . http_build_query($_GET)); ?>"><i class="fa fa-file-excel-o"></i> XLS</a>
                  <?php }) ?>
            ...
            <div class="box-body">
               <!-- Filter & Search -->
               <form name="form_filter_siswa_sma" id="form_filter_siswa_sma" action="<?= base_url('administrator/siswa_sma/index'); ?>">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-2">
                        <div class="form-group" style="margin-bottom:8px">
                           <select class="form-control chosen chosen-select" name="s">
                              ...
                              <option <?= $this->input->get('s') == 'id_siswa_sma' ? 'selected' : ''; ?> value="id_siswa_sma">ID</option>
                     ...
                     <div class="col-md-3">
                        <div class="form-group" style="margin-bottom:8px">
                           ...
                           <a class="btn btn-default" href="<?= base_url('administrator/siswa_sma'); ?>"><i class="fa fa-times"></i> Reset</a>
                           <?php endif; ?>
                        </div>
                     </div>
                  </div>
                     ...
                     <form name="form_siswa_sma" id="form_siswa_sma" action="<?= base_url('administrator/siswa_sma/index'); ?>">
                     <div class="table-responsive">
                        <table class="table table-bordered table-striped dataTable">
                           ...
                           <tbody id="tbody_siswa_sma">
                              <?php foreach ($siswa_smas as $siswa_sma) : ?>
                                 <tr>
                                    <td width="5">
                                       <input type="checkbox" class="flat-red check" name="id[]" value="<?= $siswa_sma->id_siswa_sma; ?>">
                                    </td>
                                    <td width="180" style="white-space:nowrap">
                                       <?php is_allowed('siswa_sma_view', function () use ($siswa_sma) { ?>
                                          <a href="<?= site_url('administrator/siswa_sma/view/' . $siswa_sma->id_siswa_sma); ?>" class="btn-action btn-action-view" title="Lihat Detail"><i class="fa fa-eye"></i> Detail</a>
                                          <a href="<?= site_url('administrator/siswa_sma/single_pdf/' . $siswa_sma->id_siswa_sma); ?>" class="btn-action btn-action-pdf" title="Download PDF"><i class="fa fa-file-pdf-o"></i> PDF</a>
                                       <?php }) ?>
                                       <?php is_allowed('siswa_sma_update', function () use ($siswa_sma) { ?>
                                          <a href="<?= site_url('administrator/siswa_sma/edit/' . $siswa_sma->id_siswa_sma); ?>" class="btn-action btn-action-edit" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
                                       <?php }) ?>
                                       <?php is_allowed('siswa_sma_delete', function () use ($siswa_sma) { ?>
                                          <a href="javascript:void(0);" data-href="<?= site_url('administrator/siswa_sma/delete/' . $siswa_sma->id_siswa_sma); ?>" class="btn-action btn-action-delete remove-data" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                       <?php }) ?>
                                    </td>
                                    <td><?= _ent($siswa_sma->nama_lengkap); ?></td>
                                    <td><?= _ent($siswa_sma->no_peserta); ?></td>
                                    <td><?= _ent($siswa_sma->email); ?></td>
                                    <td><?= _ent($siswa_sma->email_ms_office); ?></td>
                                    <td><?= _ent($siswa_sma->nisn); ?></td>
                                    <td><?= _ent($siswa_sma->email_ms_office_ortu); ?></td>
                                    <td><?= _ent($siswa_sma->notelp_ibu); ?></td>
                                    <td><?= _ent($siswa_sma->notelp_ayah); ?></td>
                                    <td><?= _ent($siswa_sma->sekolah_asal); ?></td>
                                    <td>
                                       <?php if (!empty($siswa_sma->foto_peserta)) : ?>
                                          <?php if (is_image($siswa_sma->foto_peserta)) : ?>
                                             <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->foto_peserta; ?>">
                                                <img src="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->foto_peserta; ?>" class="image-responsive" alt="image siswa_sma" title="foto_peserta siswa_sma" width="40px">
                                             </a>
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->foto_peserta; ?>">
                                                <img src="<?= get_icon_file($siswa_sma->foto_peserta); ?>" class="image-responsive image-icon" alt="image siswa_sma" title="foto_peserta <?= $siswa_sma->foto_peserta; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                       <?php if (!empty($siswa_sma->akte_lahir)) : ?>
                                          <?php if (is_image($siswa_sma->akte_lahir)) : ?>
                                             <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->akte_lahir; ?>">
                                                <img src="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->akte_lahir; ?>" class="image-responsive" alt="image siswa_sma" title="akte_lahir siswa_sma" width="40px">
                                             </a>
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->akte_lahir; ?>">
                                                <img src="<?= get_icon_file($siswa_sma->akte_lahir); ?>" class="image-responsive image-icon" alt="image siswa_sma" title="akte_lahir <?= $siswa_sma->akte_lahir; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                       <?php if (!empty($siswa_sma->kartu_keluarga)) : ?>
                                          <?php if (is_image($siswa_sma->kartu_keluarga)) : ?>
                                             <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->kartu_keluarga; ?>">
                                                <img src="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->kartu_keluarga; ?>" class="image-responsive" alt="image siswa_sma" title="kartu_keluarga siswa_sma" width="40px">
                                             </a>
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_sma/' . $siswa_sma->kartu_keluarga; ?>">
                                                <img src="<?= get_icon_file($siswa_sma->kartu_keluarga); ?>" class="image-responsive image-icon" alt="image siswa_sma" title="kartu_keluarga <?= $siswa_sma->kartu_keluarga; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>

                                    <td><?php if ($siswa_sma->peminatan_sma) {

                                                echo anchor('administrator/peminatan_sma/view/' . $siswa_sma->peminatan_sma . '?popup=show', $siswa_sma->peminatan_sma_peminatan, ['class' => 'popup-view']);
                                             } ?> </td>

                                    <td><?= _ent($siswa_sma->ppsbb); ?></td>
                                    <td><?php if ($siswa_sma->status_lulus) {

                                                echo anchor('administrator/status_lulus/view/' . $siswa_sma->status_lulus . '?popup=show', $siswa_sma->status_lulus_status_lulus, ['class' => 'popup-view']);
                                             } ?> </td>

                                    <td><?= _ent($siswa_sma->no_transaksi); ?></td>
                                    <td><?= _ent(jenis_ppsbb($siswa_sma->jenis_ppsbb)); ?></td>
                                    <td><?= _ent($siswa_sma->va_number); ?></td>
                                    <td><?= _ent($siswa_sma->tanggal_daftar); ?></td>
                                    <td><?= _ent($siswa_sma->tanggal_pembayaran); ?></td>
                                    <td><?= _ent($siswa_sma->tanggal_aktivasi); ?></td>
                                    <td><?= _ent($siswa_sma->tanggal_bayar_daftar_ulang); ?></td>
                                    <td><?= _ent($siswa_sma->status_daftar_ulang); ?></td>
                                 </tr>
                              <?php endforeach; ?>
                              <?php if ($siswa_sma_counts == 0) : ?>
                                 <tr>
                                    <td colspan="100">
                                       Siswa SMA data is not available
                                    </td>
                                 </tr>
                              <?php endif; ?>
                           </tbody>
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-2 padd-left-0 ">
                        <select type="text" class="form-control chosen chosen-select" name="s" id="sort">
                           <option value="">Sort By</option>
                           <option <?= $this->input->get('s') == 'id_siswa_sma' ? 'selected' : ''; ?> value="id_siswa_sma">ID Siswa</option>
                           <option <?= $this->input->get('s') == 'no_peserta' ? 'selected' : ''; ?> value="no_peserta">No Peserta</option>
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/siswa_sma'); ?>" title="<?= cclang('reset_filter'); ?>">
...
<div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content" style="border-radius:8px;overflow:hidden">
         ...
         <form action="<?= base_url('administrator/siswa_sma/import/'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body" style="padding:20px">
               <div style="background:#f8f9fa;border-radius:6px;padding:15px;margin-bottom:15px">
                  <p style="margin:0;color:#666;font-size:13px">
                     <i class="fa fa-info-circle" style="color:#3498db"></i> Import siswa baru ke tabel <strong>siswa_sma_aktif</strong>.<br>
               ...
               <div class="form-group">
                  ...
                  <select class="form-control chosen chosen-select-deselect" name="kelas_sma" id="kelas_sma" data-placeholder="-- Pilih Kelas --" required>
                     <option value=""></option>
                     <?php foreach (db_get_all_data('kelas_sma') as $row) : ?>
                        <option value="<?= $row->id_kelas_sma ?>"><?= $row->label; ?></option>
                     <?php endforeach; ?>
                  </select>
               </div>
               <div class="form-group">
                  ...
                  <p style="margin-top:8px;font-size:12px;color:#999">
                     ...
                     <a href="<?= base_url('uploads/example/format_siswa_sma.xlsx'); ?>" style="color:#3498db"><i class="fa fa-download"></i> Download template</a>
                  </p>
               </div>
            </div>
...
<script>
   $(document).ready(function() {
      ...
      $('#apply').click(function() {
         ...
         var bulk = $('#bulk');
         var serialize_bulk = $('#form_siswa_sma').serialize();
         ...
         if (bulk.val() == '1') {
            swal({
             ...
             function(isConfirm){
               if (isConfirm) {
                  document.location.href = BASE_URL + '/administrator/siswa_sma/delete?' + serialize_bulk;      
               }
             });
           ...
           return false;
            ...
            swal({
               ...
               function(inputValue) {
                  ...
                  document.location.href = BASE_URL + '/administrator/siswa_sma/update_status_daftar_ulang?' + $('#form_siswa_sma').serialize();
               })
            return false;

         } else if (bulk.val() == '3') {
            $('#st').val('3');
            document.location.href = BASE_URL + '/administrator/siswa_sma/update_status?' + $('#form_siswa_sma').serialize();
            ...
            document.location.href = BASE_URL + '/administrator/siswa_sma/download_file?' + $('#form_siswa_sma').serialize();
            return false;
         }else if (bulk.val() == '6') {
            document.location.href = BASE_URL + 'administrator/siswa_sma/download_kartu_peserta?' + $('#form_siswa_sma').serialize();
            return false;
         } else if (bulk.val() == '') {
            swal({
               title: "Upss",
