          ...
          if (!empty($data)) {
            ...
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->second_db->withquery("select va_number, id_siswa_sd as id_siswa from siswa_sd where va_number like '".$prefix.$client_id.date('y', strtotime('+1 years'))."01%' and va_number != '' and is_mutasi = '2' order by id_siswa_sd DESC","row");
                ...
                $this->second_db->update("siswa_sd", array("no_transaksi" => $no_transaksi, "va_number" => $va_number), "id_siswa_sd", $id_siswa);
