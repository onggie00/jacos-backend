               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <?php }) ?>
                        <a class="btn btn-flat btn-success" id="import-kalender" title="Import Excel" data-toggle="modal" data-target="#modal_add_new"><i class="fa fa-file-pdf-o"></i> <?= Import ?> User</a>
                     ...
                     <?php foreach($users as $user): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <!--   <a href="<?php //echo site_url('administrator/user/view/' . $user->id); ?>" class="label-default"><i class="fa  fa-newspaper-o "></i> <?php //echo cclang('view_button'); ?></a>
                              <?php }) ?> -->
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h3 class="modal-title" id="myModalLabel">Import Akun User</h3>
         </div>
         <form action="<?= base_url('administrator/user/import/'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="modal-body">
               <div class="form-group">
                  <label class="control-label col-xs-3">File</label>
                  <div class="col-xs-8">
                     <input name="file_user" class="form-control" type="file" required>
                     <span>*Silahkan isikan excel sesuai dengan format yang tersedia, berikut contoh format excel
                        <a class="text-danger" href="<?= base_url('uploads/example/format_user.xlsx'); ?>">download disini</a> </span>
                  </div>
               </div>
