               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        <?php is_allowed('web_informasi_psb_add', function(){?>
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('web_informasi_psb')]); ?>  (Ctrl+a)" href="<?=  site_url('administrator/web_informasi_psb/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', [cclang('web_informasi_psb')]); ?></a>
                        <?php }) ?>
                        <?php is_allowed('web_informasi_psb_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> <?= cclang('web_informasi_psb') ?>']); ?>" href="<?= site_url('administrator/web_informasi_psb/export'); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export'); ?> XLS</a>
                        <?php }) ?>
                        <?php is_allowed('web_informasi_psb_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> pdf <?= cclang('web_informasi_psb') ?>']); ?>" href="<?= site_url('administrator/web_informasi_psb/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> <?= cclang('export'); ?> PDF</a>
                        <?php }) ?>
                     </div>
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username"><?= cclang('web_informasi_psb') ?></h3>
                     <h5 class="widget-user-desc"><?= cclang('list_all', [cclang('web_informasi_psb')]); ?>  <i class="label bg-yellow"><?= $web_informasi_psb_counts; ?>  <?= cclang('items'); ?></i></h5>
                  </div>

                  <form name="form_web_informasi_psb" id="form_web_informasi_psb" action="<?= base_url('administrator/web_informasi_psb/index'); ?>">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <tbody id="tbody_web_informasi_psb">
                     <?php foreach($web_informasi_psbs as $web_informasi_psb): ?>
                        <tr>
                                                       <td width="5">
                      ...
                      <?php endforeach; ?>
                      <?php if ($web_informasi_psb_counts == 0) :?>
                         <tr>
                           <td colspan="100">
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-3 padd-left-0 " >
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                           ...
                           <option <?= $this->input->get('f') == 'img_file' ? 'selected' :''; ?> value="img_file">Img File</option>
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/web_informasi_psb');?>" title="<?= cclang('reset_filter'); ?>">
...
<script>
  $(document).ready(function(){
    ...
    $('#apply').click(function(){
      ...
      var bulk = $('#bulk');
      var serialize_bulk = $('#form_web_informasi_psb').serialize();
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/web_informasi_psb/delete?' + serialize_bulk;      
            }
          });
