                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group form-add">
                            <label for="id_siswa_sd" class="col-sm-2 control-label">Id Siswa SD
                                <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select class="form-control" name="id_siswa_sd[]" id="id_siswa_sd" data-placeholder="Select Id Siswa SD">
                                    <option value=""></option>
                                    <?php foreach (get_all_siswa_aktif_sd() as $row) : ?>
                                        <option value="<?= $row->id_siswa_sd_aktif ?>"><?= $row->nama_lengkap . "(" . $row->label . ")"; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $("#addForm").click(function() {
            ...
            var newField = `<div class="form-group form-add">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="id_siswa_sd[]" id="id_siswa_sd_${i}" data-placeholder="Select Id Siswa SD">
                                    <option value=""></option>
                                    <?php foreach (get_all_siswa_aktif_sd() as $row) : ?>
                                        <option value="<?= $row->id_siswa_sd_aktif ?>"><?= $row->nama_lengkap . "(" . $row->label . ")"; ?></option>
                                    <?php endforeach; ?>
            ...
            $("#form_siswa_sd_aktif").append(newField);
            $("#id_siswa_sd_" + i).select2()
            fineUpload(i)
        });
        ...
        function fineUpload(i) {
            $('#file_raport_galery_' + i).fineUploader({
                ...
                request: {
                    endpoint: BASE_URL + '/administrator/siswa_sd_aktif/upload_file_raport_file',
                    params: params
                },
                deleteFile: {
                    enabled: true,
                    endpoint: BASE_URL + '/administrator/siswa_sd_aktif/delete_file_raport_file',
                },
                thumbnails: {
                    placeholders: {
                ...
                callbacks: {
                    ...
                    onSubmit: function(id, name) {
                        ...
                        $.get(BASE_URL + '/administrator/siswa_sd_aktif/delete_file_raport_file/' + uuid);
                    },
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa_sd_aktif/add_raport_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
