...
class Prestasi_bidang extends REST_Controller {
     ...
     * saat tambah/edit data prestasi guru.
     * Mirror apiapp/siswa/Prestasi_bidang.php — tabel dipisah
     * (prestasi_guru_bidang) agar data guru/siswa bisa berbeda di masa depan.
     */
    function index_get()
    {
        $data = $this->mymodel->withquery(
            "SELECT id_prestasi_bidang, nama_bidang
             FROM prestasi_guru_bidang
