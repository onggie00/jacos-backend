...
<section class="content-header">
    <h1>
        Izin FT        <small><?= cclang('new', ['Izin FT']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Izin FT']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="izin_siswa_ft_file_izin_uuid" id="izin_siswa_ft_file_izin_uuid" type="hidden" value="<?= set_value('izin_siswa_ft_file_izin_uuid'); ?>">
                                <input class="data_file" name="izin_siswa_ft_file_izin_name" id="izin_siswa_ft_file_izin_name" type="hidden" value="<?= set_value('izin_siswa_ft_file_izin_name'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/izin_siswa_ft/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_file_izin = $('#izin_siswa_ft_file_izin_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_izin !== 'undefined') {
                    $('#izin_siswa_ft_file_izin_galery').fineUploader('deleteFile', id_file_izin);
                }
