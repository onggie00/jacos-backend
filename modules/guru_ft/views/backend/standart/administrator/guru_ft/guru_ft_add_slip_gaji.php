                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Tambah Slip Gaji Guru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_guru_ft',
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_guru[]" id="id_guru" data-placeholder="Select ID Guru">
                                    <option value=""></option>
    ...
    $(document).ready(function() {
        ...
        $("#addForm").click(function() {
            ...
            var newField = `<div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_guru[]" id="id_guru_${i}" data-placeholder="Select ID Guru">
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('guru_ft') as $row) : ?>
                                        <option value="<?= $row->id_guru ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/guru_ft/add_slip_gaji_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
