...
class Jadwal_sd extends REST_Controller
{
  ...
  public function index_post()
  {
    ...
    if($day){
      ...
      $data = $this->second_db->withquery("select j.*,m.nama as nama_pelajaran,t.label as tahun_ajaran from jadwal_sd j join mata_pelajaran m on m.id_mata_pelajaran = j.id_mata_pelajaran join tahun_ajaran t on t.id_tahun_ajaran = j.id_tahun_ajaran", "result");
    }
