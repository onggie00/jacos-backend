...
class Status_daftar_ulang_kb extends Admin
{
	...
	public function index($offset = 0)
	{
		...
		$this->data['status_daftar_ulang_kbs'] = $this->model_status_daftar_ulang_kb->get($filter, $field, $this->limit_page, $offset);
		...
		$config = [
			...
			'total_rows'   => $this->model_status_daftar_ulang_kb->count_all($filter, $field),
		...
		if ($this->form_validation->run()) {
			...
			if ($this->input->post('status') == 1) {
				...
				if ($customPayment != '0' && $customPayment != '') {
					...
					$this->mymodel->update("status_daftar_ulang_kb", array("custom_payment" => $customPayment), "id_siswa_kb", $get_daftar_ulang->id_siswa_kb);
