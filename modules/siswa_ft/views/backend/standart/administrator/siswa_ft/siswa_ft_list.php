...
<section class="content-header">
   <h1>
      <i class="fa fa-users"></i> <?= cclang('siswa_ft') ?> <small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><?= cclang('siswa_ft') ?></li>
   </ol>
</section>
      ...
      <div class="col-md-12">
         ...
         <div class="box box-warning">
            <div class="box-header with-border">
               <h3 class="box-title">
                  <i class="fa fa-graduation-cap"></i> Data Siswa FT
                  <span class="label bg-yellow" style="margin-left:10px"><?= $siswa_ft_counts; ?> Data</span>
               </h3>
               <div class="box-tools pull-right">
                  <?php is_allowed('siswa_ft_add', function () { ?>
                     <a class="btn btn-sm btn-success" title="Tambah Siswa (Ctrl+a)" href="<?= site_url('administrator/siswa_ft/add'); ?>"><i class="fa fa-plus"></i> Tambah</a>
                  <?php }) ?>
                  <?php is_allowed('siswa_ft_export', function () { ?>
                     <a class="btn btn-sm btn-success" title="Export XLS" href="<?= site_url('administrator/siswa_ft/export?' . http_build_query($_GET)); ?>"><i class="fa fa-file-excel-o"></i> XLS</a>
                  <?php }) ?>
            ...
            <div class="box-body">
               <!-- Filter & Search -->
               <form name="form_filter_siswa_ft" id="form_filter_siswa_ft" action="<?= base_url('administrator/siswa_ft/index'); ?>">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-2">
                        <div class="form-group" style="margin-bottom:8px">
                           <select class="form-control chosen chosen-select" name="s">
                              ...
                              <option <?= $this->input->get('s') == 'id_siswa_ft' ? 'selected' : ''; ?> value="id_siswa_ft">ID</option>
                     ...
                     <div class="col-md-3">
                        <div class="form-group" style="margin-bottom:8px">
                           ...
                           <a class="btn btn-default" href="<?= base_url('administrator/siswa_ft'); ?>"><i class="fa fa-times"></i> Reset</a>
                           <?php endif; ?>
                        </div>
                     </div>
                  </div>
                     ...
                     <form name="form_siswa_ft" id="form_siswa_ft" action="<?= base_url('administrator/siswa_ft/index'); ?>">
                        ...
                        <table class="table table-bordered table-striped dataTable">
                           <thead>
                              <tr class="">
                                 ...
                                 <th> <?= cclang('status_daftar_ulang') ?></th>
                                 <th> <?= cclang('tanggal_daftar') ?></th>
                                 <th> <?= cclang('gelombang') ?></th>
                                 <th> <?= cclang('tahun_ajaran') ?></th>
                              </tr>
                           </thead>
                           <tbody id="tbody_siswa_ft">
                              <?php foreach ($siswa_fts as $siswa_ft) : ?>
                                 <tr>
                                    <td width="5">
                                       <input type="checkbox" class="flat-red check" name="id[]" value="<?= $siswa_ft->id_siswa_ft; ?>">
                                    </td>
                                    <td width="180" style="white-space:nowrap">
                                       <?php is_allowed('siswa_ft_view', function () use ($siswa_ft) { ?>
                                          <a href="<?= site_url('administrator/siswa_ft/view/' . $siswa_ft->id_siswa_ft); ?>" class="btn-action btn-action-view" title="Lihat Detail"><i class="fa fa-eye"></i> Detail</a>
                                          <a href="<?= site_url('administrator/siswa_ft/single_pdf/' . $siswa_ft->id_siswa_ft); ?>" class="btn-action btn-action-pdf" title="Download PDF"><i class="fa fa-file-pdf-o"></i> PDF</a>
                                       <?php }) ?>
                                       <?php is_allowed('siswa_ft_update', function () use ($siswa_ft) { ?>
                                          <a href="<?= site_url('administrator/siswa_ft/edit/' . $siswa_ft->id_siswa_ft); ?>" class="btn-action btn-action-edit" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
                                       <?php }) ?>
                                       <?php is_allowed('siswa_ft_delete', function () use ($siswa_ft) { ?>
                                          <a href="javascript:void(0);" data-href="<?= site_url('administrator/siswa_ft/delete/' . $siswa_ft->id_siswa_ft); ?>" class="btn-action btn-action-delete remove-data" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                       <?php }) ?>
                                    </td>
                                    <td><?= _ent($siswa_ft->nama_lengkap); ?></td>
                                    <td><?= _ent($siswa_ft->no_peserta); ?></td>
                                    <td><?= _ent($siswa_ft->email); ?></td>
                                    <td><?= _ent($siswa_ft->notelp_ibu); ?></td>
                                    <td><?= _ent($siswa_ft->notelp_ayah); ?></td>
                                    <td><?= _ent($siswa_ft->sekolah_asal); ?></td>
                                    <td>
                                       <?php if (!empty($siswa_ft->foto_peserta)) : ?>
                                          ...
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_ft/' . $siswa_ft->foto_peserta; ?>">
                                                <img src="<?= get_icon_file($siswa_ft->foto_peserta); ?>" class="image-responsive image-icon" alt="image siswa_ft" title="foto_peserta <?= $siswa_ft->foto_peserta; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                       <?php if (!empty($siswa_ft->akte_lahir)) : ?>
                                          ...
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_ft/' . $siswa_ft->akte_lahir; ?>">
                                                <img src="<?= get_icon_file($siswa_ft->akte_lahir); ?>" class="image-responsive image-icon" alt="image siswa_ft" title="akte_lahir <?= $siswa_ft->akte_lahir; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                       <?php if (!empty($siswa_ft->kartu_keluarga)) : ?>
                                          ...
                                          <?php else : ?>
                                             <a href="<?= BASE_URL . 'uploads/siswa_ft/' . $siswa_ft->kartu_keluarga; ?>">
                                                <img src="<?= get_icon_file($siswa_ft->kartu_keluarga); ?>" class="image-responsive image-icon" alt="image siswa_ft" title="kartu_keluarga <?= $siswa_ft->kartu_keluarga; ?>" width="40px">
                                             </a>
                                          <?php endif; ?>
                                       <?php endif; ?>
                                    </td>
                                    <td><?php if ($siswa_ft->status_lulus) {
                                          if ($siswa_ft->status_lulus == 4){
                                             echo anchor('administrator/status_lulus/view/' . $siswa_ft->status_lulus . '?popup=show', $siswa_ft->status_lulus_status_lulus.' '.$siswa_ft->cadangan_no, ['class' => 'popup-view']);
                                          }
                                          else{
                                             echo anchor('administrator/status_lulus/view/' . $siswa_ft->status_lulus . '?popup=show', $siswa_ft->status_lulus_status_lulus, ['class' => 'popup-view']);
                                          }
                                       } ?> </td>
                                    <td><?= _ent($siswa_ft->status_daftar_ulang); ?></td>
                                    <td><?= _ent($siswa_ft->tanggal_daftar); ?></td>
                                    <td><?= _ent($siswa_ft->gelombang); ?></td>
                                    <td><?= _ent($siswa_ft->tahun_ajaran); ?></td>
                                    
                                 </tr>
                              <?php endforeach; ?>
                              <?php if ($siswa_ft_counts == 0) : ?>
                                 <tr>
                                    <td colspan="100">
                                       Siswa France Track data is not available
                                    </td>
                                 </tr>
                              <?php endif; ?>
                           </tbody>
               ...
               <div class="row">
                  <div class="col-md-8">
                     <div class="col-sm-2 padd-left-0 ">
                        ...
                        <input type="hidden" id="cadangan_no" name="cadangan_no">
                     </div>
                     <div class="col-sm-2 padd-left-0 ">
                     ...
                     <div class="col-sm-2 padd-left-0 ">
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field">
                           ...
                           <option <?= $this->input->get('f') == 'gelombang' ? 'selected' : ''; ?> value="gelombang">Gelombang</option>
                           <option <?= $this->input->get('f') == 'sekolah_asal' ? 'selected' : ''; ?> value="sekolah_asal">Sekolah Asal</option>
                           <option <?= $this->input->get('f') == 'status_lulus' ? 'selected' : ''; ?> value="status_lulus">Status Lulus</option>
                     ...
                     <div class="col-sm-2 padd-left-0 ">
                        <select type="text" class="form-control chosen chosen-select" name="s" id="sort">
                           <option value="">Sort By</option>
                           <option <?= $this->input->get('s') == 'id_siswa_ft' ? 'selected' : ''; ?> value="id_siswa_ft">ID Siswa</option>
                           <option <?= $this->input->get('s') == 'no_peserta' ? 'selected' : ''; ?> value="no_peserta">No Peserta</option>
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/siswa_ft'); ?>" title="<?= cclang('reset_filter'); ?>">
...
<div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content" style="border-radius:8px;overflow:hidden">
         ...
         <form action="<?= base_url('administrator/siswa_ft/import/'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body" style="padding:20px">
               <div style="background:#f8f9fa;border-radius:6px;padding:15px;margin-bottom:15px">
                  <p style="margin:0;color:#666;font-size:13px">
                     <i class="fa fa-info-circle" style="color:#3498db"></i> Import siswa baru ke tabel <strong>siswa_ft_aktif</strong>.<br>
               ...
               <div class="form-group">
                  ...
                  <select class="form-control chosen chosen-select-deselect" name="kelas_ft" id="kelas_ft" data-placeholder="-- Pilih Kelas --" required>
                     <option value=""></option>
               ...
               <div class="form-group">
                  ...
                  <p style="margin-top:8px;font-size:12px;color:#999">
                     ...
                     <a href="<?= base_url('uploads/example/format_siswa_ft.xlsx'); ?>" style="color:#3498db"><i class="fa fa-download"></i> Download template</a>
                  </p>
               </div>
            </div>
...
<script>
   $(document).ready(function() {
      ...
      $('#apply').click(function() {
         ...
         var bulk = $('#bulk');
         var serialize_bulk = $('#form_siswa_ft').serialize();
         ...
         if (bulk.val() == '1') {
            ...
            function(isConfirm){
               if (isConfirm) {
                  document.location.href = BASE_URL + '/administrator/siswa_ft/delete?' + serialize_bulk;      
               }
            });
            ...
            swal({
               ...
               function(inputValue) {
                  ...
                  document.location.href = BASE_URL + '/administrator/siswa_ft/update_status_daftar_ulang?' + $('#form_siswa_ft').serialize();
               })
            return false;

         } else if (bulk.val() == '3') {
            $('#st').val('3');
            document.location.href = BASE_URL + '/administrator/siswa_ft/update_status?' + $('#form_siswa_ft').serialize();
            ...
            swal({
                  title: "Masukkan Nomor Urut Cadangan",
                  text: "1-15",
                  type: "input",
                  showCancelButton: true,
                  closeOnConfirm: false,
                  animation: "slide-from-top",
                  inputPlaceholder: "1-15"
               },
               function(inputValue) {
                  // console.log(inputValue)
                  $('#st').val('4');
                  $('#cadangan_no').val(inputValue);
                  document.location.href = BASE_URL + '/administrator/siswa_ft/update_status?' + $('#form_siswa_ft').serialize();
               })
            return false;
         } else if (bulk.val() == '5') {
            document.location.href = BASE_URL + '/administrator/siswa_ft/download_file?' + $('#form_siswa_ft').serialize();
            return false;
         } else if (bulk.val() == '6') {
            document.location.href = BASE_URL + 'administrator/siswa_ft/download_kartu_peserta?' + $('#form_siswa_ft').serialize();
            return false;
         } else if (bulk.val() == '') {
            swal({
               title: "Upss",
