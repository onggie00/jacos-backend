...
<section class="content-header">
   <h1>
      Spp Ft      <small><?= cclang('detail', ['Spp Ft']); ?> </small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Detail Spp Ft</h5>
                     <hr>
                  </div>

                 
                  <div class="form-horizontal" name="form_spp_ft" id="form_spp_ft" >
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($spp_ft->siswa_ft_aktif_nama_lengkap); ?>
                        </div>
                    </div>
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit spp_ft (Ctrl+e)" href="<?= site_url('administrator/spp_ft/edit/'.$spp_ft->id); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Spp Ft']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/spp_ft/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Spp Ft']); ?></a>
                     </div>
