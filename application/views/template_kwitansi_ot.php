...
<body >
	<div style="padding-left: 50px;">
		<table>
			<tr>
				<td>
					<img style="width:160px;height:50px;" src="<?php echo FCPATH . '/uploads/logo_labschool_cibubur.png'; ?>" />
				</td>
			</tr>
		</table>
		...
		<div style="border:1px solid black;width:700px;margin-top:10px;">
			<table style="font-size: 10pt;font-weight: bold;">
				<tr>
					<td style="padding:10px;">NAMA TAGIHAN</td>
					<td style="padding:10px;">:</td>
					<td style="padding:10px;"><?php echo $nama_transaksi; ?></td>
				</tr>
				<tr>
					<td style="padding:10px;">TAHUN AJARAN</td>
					<td style="padding:10px;">:</td>
					<td style="padding:10px;"><?php echo htmlspecialchars($tahun_ajaran); ?></td>
				</tr>
			</table>
			...
			<table style="font-size: 8pt;">
				...
				<tr>
					...
					<td style="padding: 10px;">:</td>
					<td style="font-weight: bold;padding: 10px;"><?php echo $nama_kelas; ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="padding: 10px;">:</td>
					<td style="font-weight: bold;padding: 10px;"><?php echo $tipe_bank; ?></td>
				</tr>
				<tr>
