                           ...
                           <div class="form-group">
                              ...
                              <select name="id_tingkatan" id="select_tingkatan_terlambat" class="form-control input-sm">
                                 ...
                                 <?php foreach($list_tingkatan as $t): ?>
                                    <option value="<?= $t->id_tingkatan_sma; ?>"><?= htmlspecialchars($t->label); ?></option>
                                 <?php endforeach; ?>
                              </select>
                           </div>
                           <div class="form-group">
                              ...
                              <select name="id_kelas" id="select_kelas_terlambat" class="form-control input-sm">
                                 ...
                                 <?php foreach($list_kelas as $k): ?>
                                    <option value="<?= $k->id_kelas_sma; ?>"><?= htmlspecialchars($k->label); ?></option>
                                 <?php endforeach; ?>
                              </select>
                           </div>
...
$(document).ready(function(){
   ...
   $('#btn_load_terlambat').click(function(){
      ...
      $.ajax({
         url: '<?= site_url('administrator/presensi_sma/get_siswa_terlambat'); ?>',
         type: 'POST',
         data: {
   ...
   $(document).on('click', '.btn-riwayat-terlambat', function(){
      ...
      $.ajax({
         url: '<?= site_url('administrator/presensi_sma/get_riwayat_terlambat'); ?>',
         type: 'POST',
         data: {
            id_siswa_aktif: id_siswa,
            id_tahun_ajaran: ta,
