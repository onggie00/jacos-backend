                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                      <?php is_allowed('keys_add', function(){?>
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', 'API Keys'); ?> (Ctrl+a)" href="<?=  site_url('administrator/keys/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', 'API Keys'); ?></a>
                        <?php }) ?>
                      <?php is_allowed('keys_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', 'Keys'); ?>" href="<?= site_url('administrator/keys/export'); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export', 'Excel'); ?></a>
                        <?php }) ?>
                        <?php is_allowed('keys_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', 'PDF Keys'); ?>" href="<?= site_url('administrator/keys/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> <?= cclang('export', 'PDF'); ?></a>
                        <?php }) ?>
                     </div>
                     ...
                     <?php foreach($keyss as $keys): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/keys/delete/' . $keys->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> <?= cclang('remove_button'); ?></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
