...
class Riwayat_presensi_ibadah extends REST_Controller {
    ...
    public function index_post()
    {
      ...
      if(isset($headers['x-token']))
        ...
        $cek_presensi = $this->mymodel->withquery("select i.id, i.id_siswa_aktif, s.nama_lengkap, k.label as nama_kelas, i.jenjang, i.id_ibadah, p.ibadah, i.tanggal, i.waktu, i.jumlah_rakaat, i.keterangan from ibadah i 
        ...
        join ibadah_setting p on i.id_ibadah = p.id where i.deleted_at is null and i.id_siswa_aktif = '".$id_siswa_aktif."' ".$where." ","result");
