          ...
          if (!empty($data)) {
            ...
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->mymodel->withquery("select va_number, id_siswa_sd as id_siswa from siswa_sd where va_number like '".$prefix.$client_id.date('y', strtotime('+1 years'))."01%' and va_number != '' and is_mutasi = '2' order by id_siswa_sd DESC","row");
