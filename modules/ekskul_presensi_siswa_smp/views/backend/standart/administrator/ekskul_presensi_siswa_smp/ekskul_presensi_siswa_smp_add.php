...
<section class="content-header">
    <h1>
        Presensi Siswa SMP        <small><?= cclang('new', ['Presensi Siswa SMP']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Presensi Siswa SMP']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="keterangan_presensi" id="keterangan_presensi" placeholder="Keterangan Presensi" value="<?= set_value('keterangan_presensi'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_presensi_siswa_smp/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
