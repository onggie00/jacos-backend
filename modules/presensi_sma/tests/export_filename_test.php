...
$controller_path = dirname(__DIR__) . '/controllers/backend/Presensi_sma.php';
...
if (!$failures) {
	...
	$reflection = new ReflectionClass('Presensi_sma');
	$controller = $reflection->newInstanceWithoutConstructor();
	$method = $reflection->getMethod('_build_export_filename');
	$method->setAccessible(true);

	assert_filename_same(
		'Presensi SMA - 2026-07-01-2026-07-20-X IPA.xls',
		$method->invoke($controller, '2026-07-01', '2026-07-20', 'X IPA'),
	...
	assert_filename_same(
		'Presensi SMA - 2026-07-01-2026-07-20-Semua.xls',
...
echo 'PASS: Filename export presensi SMA sesuai filter.' . PHP_EOL;
