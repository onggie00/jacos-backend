...
<section class="content-header">
   <h1>
      Guru Sma      <small><?= cclang('detail', ['Guru Sma']); ?> </small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Detail Guru Sma</h5>
                     <hr>
                  </div>

                 
                  <div class="form-horizontal" name="form_guru_sma" id="form_guru_sma" >
                   
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Id Guru </label>

                        <div class="col-sm-8">
                           <?= _ent($guru_sma->id_guru); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($guru_sma->posisi_guru_nama_posisi); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($guru_sma->satuan_pendidikan); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($guru_sma->mata_pelajaran_sma_nama_mapel); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($guru_sma->status_kepegawaian); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($guru_sma->informasi_kepala_pimpinan); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($guru_sma->foto_profil)): ?>
                              ...
                              <?php else: ?>
                              <label>
                                <a href="<?= BASE_URL . 'administrator/file/download/guru_sma/' . $guru_sma->foto_profil; ?>">
                                 <img src="<?= get_icon_file($guru_sma->foto_profil); ?>" class="image-responsive" alt="image guru_sma" title="foto_profil <?= $guru_sma->foto_profil; ?>" width="40px"> 
                               <?= $guru_sma->foto_profil ?>
                               </a>
                               </label>
                              <?php endif; ?>
                        </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                             <?php if (is_image($guru_sma->slip_gaji)): ?>
                              <a class="fancybox" rel="group" href="<?= BASE_URL . 'uploads/guru_sma/' . $guru_sma->slip_gaji; ?>">
                                <img src="<?= BASE_URL . 'uploads/guru_sma/' . $guru_sma->slip_gaji; ?>" class="image-responsive" alt="image guru_sma" title="slip_gaji guru_sma" width="40px">
                              </a>
                              <?php else: ?>
                              <label>
                                <a href="<?= BASE_URL . 'administrator/file/download/guru_sma/' . $guru_sma->slip_gaji; ?>">
                                 <img src="<?= get_icon_file($guru_sma->slip_gaji); ?>" class="image-responsive" alt="image guru_sma" title="slip_gaji <?= $guru_sma->slip_gaji; ?>" width="40px"> 
                               <?= $guru_sma->slip_gaji ?>
                               </a>
                               </label>
                              <?php endif; ?>
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit guru_sma (Ctrl+e)" href="<?= site_url('administrator/guru_sma/edit/'.$guru_sma->id_guru); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Guru Sma']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/guru_sma/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Guru Sma']); ?></a>
                     </div>
