    ...
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
       ...
       $('#{table_name}_<?= $field_all[$input]['input_name']; ?>_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/{table_name}/upload_<?= $field_all[$input]['input_name']; ?>_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: BASE_URL + '/administrator/{table_name}/delete_<?= $field_all[$input]['input_name']; ?>_file'
          },
          thumbnails: {
              placeholders: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/{table_name}/get_<?= $field_all[$input]['input_name']; ?>_file/{php_open_tag_echo} ${table_name}->{primary_key}; {php_close_tag}',
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/{table_name}/delete_<?= $field_all[$input]['input_name']; ?>_file/' + uuid);
              },
