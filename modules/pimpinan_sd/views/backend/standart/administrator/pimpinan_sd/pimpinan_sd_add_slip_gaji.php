                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Tambah Slip Gaji Pimpinan</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_pimpinan[]" id="id_pimpinan" data-placeholder="Select ID Pimpinan">
                                    <option value=""></option>
    ...
    $(document).ready(function() {
        ...
        $("#addForm").click(function() {
            ...
            var newField = `<div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_pimpinan[]" id="id_pimpinan_${i}" data-placeholder="Select ID Pimpinan">
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('pimpinan_sd') as $row) : ?>
                                        <option value="<?= $row->id_pimpinan ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/pimpinan_sd/add_slip_gaji_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
