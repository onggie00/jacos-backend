                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_tk_foto_peserta_uuid" id="siswa_tk_foto_peserta_uuid" type="hidden" value="<?= set_value('siswa_tk_foto_peserta_uuid'); ?>">
                                <input class="data_file" name="siswa_tk_foto_peserta_name" id="siswa_tk_foto_peserta_name" type="hidden" value="<?= set_value('siswa_tk_foto_peserta_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_tk_akte_lahir_uuid" id="siswa_tk_akte_lahir_uuid" type="hidden" value="<?= set_value('siswa_tk_akte_lahir_uuid'); ?>">
                                <input class="data_file" name="siswa_tk_akte_lahir_name" id="siswa_tk_akte_lahir_name" type="hidden" value="<?= set_value('siswa_tk_akte_lahir_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_tk_kartu_keluarga_uuid" id="siswa_tk_kartu_keluarga_uuid" type="hidden" value="<?= set_value('siswa_tk_kartu_keluarga_uuid'); ?>">
                                <input class="data_file" name="siswa_tk_kartu_keluarga_name" id="siswa_tk_kartu_keluarga_name" type="hidden" value="<?= set_value('siswa_tk_kartu_keluarga_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select name="id_tingkatan" id="id_tingkatan" class="form-control">
                                    ...
                                    <option value="<?= $row->id_tingkatan_tk ?>" <?= set_select('id_tingkatan', $row->id_tingkatan_tk); ?>><?= $row->label ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa_tk/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
                .done(function(res) {
                    ...
                    if (res.success) {
                        var id_foto_peserta = $('#siswa_tk_foto_peserta_galery').find('li').attr('qq-file-id');
                        var id_akte_lahir = $('#siswa_tk_akte_lahir_galery').find('li').attr('qq-file-id');
                        var id_kartu_keluarga = $('#siswa_tk_kartu_keluarga_galery').find('li').attr('qq-file-id');
                        ...
                        if (typeof id_foto_peserta !== 'undefined') {
                            $('#siswa_tk_foto_peserta_galery').fineUploader('deleteFile', id_foto_peserta);
                        }
                        if (typeof id_akte_lahir !== 'undefined') {
                            $('#siswa_tk_akte_lahir_galery').fineUploader('deleteFile', id_akte_lahir);
                        }
                        if (typeof id_kartu_keluarga !== 'undefined') {
                            $('#siswa_tk_kartu_keluarga_galery').fineUploader('deleteFile', id_kartu_keluarga);
                        }
