...
<section class="content-header">
    <h1>
        Program Anggaran Email (Penerima)        <small><?= cclang('new', ['Program Anggaran Email (Penerima)']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Program Anggaran Email (Penerima)']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/program_anggaran_email/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
