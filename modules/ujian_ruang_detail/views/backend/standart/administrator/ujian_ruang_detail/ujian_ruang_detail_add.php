...
<section class="content-header">
    <h1>
        Ujian Ruang Detail        <small><?= cclang('new', ['Ujian Ruang Detail']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Ujian Ruang Detail']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_ruang_kelas" id="id_ruang_kelas" data-placeholder="Select Kelas" >
                                    ...
                                    <option value="<?= $row->id_ruang_kelas ?>"><?= $row->kelas; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomor_peserta_ujian" id="nomor_peserta_ujian" placeholder="Nomor Peserta Ujian" value="<?= set_value('nomor_peserta_ujian'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="boleh_ujian" value="YA"> YA                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="boleh_ujian" value="TIDAK"> TIDAK                                    </label>
                                    </div>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_siswa" id="nama_siswa" placeholder="Nama Siswa" value="<?= set_value('nama_siswa'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ujian_ruang_detail/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
