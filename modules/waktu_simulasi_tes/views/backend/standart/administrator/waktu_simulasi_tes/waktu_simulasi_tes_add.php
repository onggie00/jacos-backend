...
<section class="content-header">
    <h1>
        Waktu Simulasi Tes        <small><?= cclang('new', ['Waktu Simulasi Tes']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Waktu Simulasi Tes']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tgl_ujian"  placeholder="Tanggal Ujian" id="tgl_ujian">
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right timepicker" name="waktu_mulai" id="waktu_mulai">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right timepicker" name="waktu_selesai" id="waktu_selesai">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="simulasi" id="simulasi" placeholder="Keterangan Simulasi" value="<?= set_value('simulasi'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/waktu_simulasi_tes/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
