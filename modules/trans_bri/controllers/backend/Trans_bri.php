...
class Trans_bri extends Admin	
{
	...
	public function __construct()
	{
		...
		$this->load->model('model_trans_bri');
	...
	*/
	...
	{
		$this->is_allowed('trans_bri_list');
		...
		$this->data['trans_bri_counts'] = count($res);

		$config = [
			'base_url'     => 'administrator/trans_bri/index/',
		...
		$this->render('backend/standart/administrator/trans_bri/trans_bri_list', $this->data);
	}
	...
	*/
	...
	{
		$this->is_allowed('trans_bri_delete');
		...
		if ($remove) {
            set_message(cclang('has_been_deleted', 'trans_bri'), 'success');
        } else {
            set_message(cclang('error_delete', 'trans_bri'), 'error');
        }
	...
	*/
	...
	{
		$this->is_allowed('trans_bri_view');

		$this->data['trans_bri'] = $this->model_trans_bri->join_avaiable()->filter_avaiable()->find($id);

		$this->template->title('Trans Bri Detail');
		$this->render('backend/standart/administrator/trans_bri/trans_bri_view', $this->data);
	}
	...
	*/
	...
	{
		$trans_bri = $this->model_trans_bri->find($id);

		
		
		return $this->model_trans_bri->remove($id);
	}
	...
	*/
	public function export()
	{
		...
		// dd($res);
		$this->model_trans_bri->export_bri($res, 'trans_bri');
	}
	...
	*/
	...
	{
		$this->is_allowed('trans_bri_export');

		$this->model_trans_bri->pdf('trans_bri', 'trans_bri');
	}
	...
	public function single_pdf($id = null)
	{
        ...
        $data = $this->model_trans_bri->find($id);
