...
class Create_tagihan_sd_noslip extends REST_Controller
{
  ...
  public function index_post()
  {
    ...
    //cek tagihan lain (tanpa filter kategori — blokir semua tagihan lain
    // aktif, mirror Create_tagihan_noslip.php versi SMP)
    ...
    if ($va_number == "") {
      ...
      $datas = array(
        ...
        'nama' => str_replace("'","",$get_siswa->nama_lengkap),
        'amount' => $total_biaya,
