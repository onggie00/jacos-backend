...
<section class="content-header">
    <h1>
        Pimpinan Sma        <small><?= cclang('new', ['Pimpinan Sma']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pimpinan Sma']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="pimpinan_sma_foto_profil_uuid" id="pimpinan_sma_foto_profil_uuid" type="hidden" value="<?= set_value('pimpinan_sma_foto_profil_uuid'); ?>">
                                <input class="data_file" name="pimpinan_sma_foto_profil_name" id="pimpinan_sma_foto_profil_name" type="hidden" value="<?= set_value('pimpinan_sma_foto_profil_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="pimpinan_sma_slip_gaji_uuid" id="pimpinan_sma_slip_gaji_uuid" type="hidden" value="<?= set_value('pimpinan_sma_slip_gaji_uuid'); ?>">
                                <input class="data_file" name="pimpinan_sma_slip_gaji_name" id="pimpinan_sma_slip_gaji_name" type="hidden" value="<?= set_value('pimpinan_sma_slip_gaji_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control " name="presensi_role"  placeholder="SMA" id="presensi_role">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pimpinan_sma/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_foto_profil = $('#pimpinan_sma_foto_profil_galery').find('li').attr('qq-file-id');
            var id_slip_gaji = $('#pimpinan_sma_slip_gaji_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_foto_profil !== 'undefined') {
                    $('#pimpinan_sma_foto_profil_galery').fineUploader('deleteFile', id_foto_profil);
                }
            if (typeof id_slip_gaji !== 'undefined') {
                    $('#pimpinan_sma_slip_gaji_galery').fineUploader('deleteFile', id_slip_gaji);
                }
