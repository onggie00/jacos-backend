...
<script>
    $(document).ready(function() {
        ...
        $("#addForm").click(function() {
            ...
            $("#form_siswa_tk_aktif").append(newField);
            $("#id_siswa_tk_" + i).select2()
            fineUpload(i)
        });
        ...
        function fineUpload(i) {
            $('#file_raport_galery_' + i).fineUploader({
                ...
                request: {
                    endpoint: BASE_URL + '/administrator/siswa_tk_aktif/upload_file_raport_file',
                    params: params
                },
                deleteFile: {
                    enabled: true,
                    endpoint: BASE_URL + '/administrator/siswa_tk_aktif/delete_file_raport_file',
                },
                thumbnails: {
                    placeholders: {
                ...
                callbacks: {
                    ...
                    onSubmit: function(id, name) {
                        ...
                        $.get(BASE_URL + '/administrator/siswa_tk_aktif/delete_file_raport_file/' + uuid);
                    },
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa_tk_aktif/add_raport_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
