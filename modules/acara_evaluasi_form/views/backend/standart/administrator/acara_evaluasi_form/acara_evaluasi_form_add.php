...
<section class="content-header">
    <h1>
        Evaluasi Acara Form        <small><?= cclang('new', ['Evaluasi Acara Form']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Evaluasi Acara Form']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="tipe_pertanyaan" id="tipe_pertanyaan" data-placeholder="Select Tipe Pertanyaan" >
                                    ...
                                    <option value="checklist">Ceklis / List (lebih dari 1 pilihan)</option>
                                    <option value="radio">Opsi (1 pilihan)</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="is_required" value="0"> TIDAK                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="is_required" value="1"> YA                                    </label>
                                    </div>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <textarea id="jawaban_pertanyaan" name="jawaban_pertanyaan" rows="5" cols="80"><?= set_value('Jawaban Pertanyaan'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_urut" id="no_urut" placeholder="Nomor Pertanyaan" value="<?= set_value('no_urut'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      var pertanyaan = CKEDITOR.instances.pertanyaan;
            CKEDITOR.replace('jawaban_pertanyaan'); 
      var jawaban_pertanyaan = CKEDITOR.instances.jawaban_pertanyaan;
      ...
      $('.btn_save').click(function(){
        ...
        $('#pertanyaan').val(pertanyaan.getData());
                $('#jawaban_pertanyaan').val(jawaban_pertanyaan.getData());
        ...
        $.ajax({
          url: BASE_URL + '/administrator/acara_evaluasi_form/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
