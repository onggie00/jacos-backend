    ...
    <div class="row">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Grafik Presensi per Tingkat</h3>
            ...
            <div style="border: 1px solid #1E40AF; padding: 10px 20px;width: 200px;border-radius: 10px">Total Siswa : <span id="total_siswa"><b><?= $total_siswa; ?></b></span></div>
                ...
                <div class="chart" id="chart-presensi-tingkatan" style="height: 300px;"></div>
                <div>
...
<script>
    ...
    let chart = new Morris.Bar({
        element: 'chart-presensi-tingkatan',
        data: [],
        xkey: 'bulan',
    ...
    $('#unit').change(function () {
        ...
        $('#btn_filter').click(function () {
            ...
            $.ajax({
                url: '<?= site_url('administrator/dashboard_presensi/chart_presensi_tingkatan') ?>',
                method: 'POST',
                data: { start_date: start, end_date: end , unit: unit , tingkatan: tingkatan},
                dataType: 'json',
                success: function (response) {
