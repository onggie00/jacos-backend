                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Tambah raport Siswa KB aktif</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group form-add">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_siswa_kb[]" id="id_siswa_kb" data-placeholder="Select Id Siswa KB">
                                    <option value=""></option>
    ...
    $(document).ready(function() {
        ...
        $("#addForm").click(function() {
            ...
            var newField = `<div class="form-group form-add">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="id_siswa_kb[]" id="id_siswa_kb_${i}" data-placeholder="Select Id Siswa KB">
                                    <option value=""></option>
                                    <?php foreach (get_all_siswa_aktif_sd() as $row) : ?>
                                        <option value="<?= $row->id_siswa_kb_aktif ?>"><?= $row->nama_lengkap . "(" . $row->label . ")"; ?></option>
                                    <?php endforeach; ?>
