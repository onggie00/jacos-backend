...
<section class="content-header">
    <h1>
        Siswa Ft Aktif        <small><?= cclang('new', ['Siswa Ft Aktif']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa Ft Aktif']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_ft" id="id_siswa_ft" data-placeholder="Select Id Siswa Ft" >
                                    ...
                                    <option value="<?= $row->id_siswa_ft ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                <b>Input  Siswa Ft</b> Max Length : 11.</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="penghasilan_ayah" id="penghasilan_ayah" placeholder="Penghasilan Ayah" value="<?= set_value('penghasilan_ayah'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="penghasilan_ibu" id="penghasilan_ibu" placeholder="Penghasilan Ibu" value="<?= set_value('penghasilan_ibu'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tgl_lahir_ayah"  placeholder="Tgl Lahir Ayah" id="tgl_lahir_ayah">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tgl_lahir_ibu"  placeholder="Tgl Lahir Ibu" id="tgl_lahir_ibu">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa_ft_aktif/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
