...
/**
 * --------------------------------------------------------------------------
 * Presensi PJOK (Pimpinan) — Riwayat
 * --------------------------------------------------------------------------
 * GET /apiapp/pimpinan/presensi_pjok_riwayat
 */
class Presensi_pjok_riwayat extends REST_Controller
{
