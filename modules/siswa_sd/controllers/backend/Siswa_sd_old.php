 ...
 *|
 */
class Siswa_sd_old extends Admin
{
	...
	public function index($offset = 0)
	{
		...
		$this->data['siswa_sds'] = $this->model_siswa_sd->get($filter, $field, $this->limit_page, $offset, [], $sort, $sort_type);
	...
	public function edit_save($id)
	{
		...
		if ($this->form_validation->run()) {
			...
			if (!empty($save_siswa_sd) && $save_data['status_lulus'] == "2") {
				...
				// 	$this->mymodel->update("siswa_sd", array("no_transaksi" => $no_transaksi), "id_siswa_sd", $id);
	...
	public function export()
	{
		...
		$this->model_siswa_sd->export_siswa('siswa_sd', 'siswa_sd');
	}
