          ...
          if (!empty($data)) {
            ...
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                $get_no_urut = $this->second_db->withquery("select va_number_bri, id_siswa_sd as id_siswa from siswa_sd where va_number_bri like '".$prefix.$client_id.date('y', strtotime('+1 years'))."01%' and va_number_bri != '' and is_mutasi = '2' order by id_siswa_sd DESC","row");
                ...
                // $va_number_bri = $prefix.$client_id.date("y", strtotime('+1 years'))."01".$no_urut;
                #####
                ...
                #####
                $id_transaksi = $this->second_db->insertid("transaksi",$res_data);
                ...
                $get_transaksi = $this->second_db->withquery("select id_transaksi, no_transaksi, va_number_bri, nama_bank, total_biaya, expired_datetime from transaksi where id_transaksi = '".$id_transaksi."'","row");
