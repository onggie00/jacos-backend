...
<section class="content-header">
    <h1>
        Laporan Tka Indikator        <small><?= cclang('new', ['Laporan Tka Indikator']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Laporan Tka Indikator']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="judul_kategori" id="judul_kategori" placeholder="Kategori" value="<?= set_value('judul_kategori'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="soal" id="soal" placeholder="Soal" value="<?= set_value('soal'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_urut" id="no_urut" placeholder="No Urut" value="<?= set_value('no_urut'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tahun" id="tahun" placeholder="Tahun" value="<?= set_value('tahun'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/laporan_tka_indikator/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
