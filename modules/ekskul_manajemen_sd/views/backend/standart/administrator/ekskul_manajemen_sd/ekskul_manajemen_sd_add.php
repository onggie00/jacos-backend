...
<section class="content-header">
    <h1>
        Manajemen Ekskul SD        <small><?= cclang('new', ['Manajemen Ekskul SD']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Manajemen Ekskul SD']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="notelp_pelatih" id="notelp_pelatih" placeholder="Notelp" value="<?= set_value('notelp_pelatih'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_manajemen_sd/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
