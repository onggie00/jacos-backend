            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', ['Crud']); ?> (Ctrl+a)" href="<?=  site_url('administrator/crud/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', ['Crud']); ?></a>
                        <?php }) ?>
                                                <?php is_allowed('crud_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export', ['Crud']); ?>" href="<?= site_url('administrator/crud/export'); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export_button'); ?></a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_crud" id="form_crud" action="<?= base_url('administrator/crud/index'); ?>">
                     ...
                     <?php foreach($cruds as $crud): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/' . $crud->table_name); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> <?= cclang('view_button'); ?>
                              <?php }) ?>
                              ...
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/crud/delete/' . $crud->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> <?= cclang('remove_button'); ?></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/crud');?>" title=" <?= cclang('reset_filter'); ?>">
     ...
     $('#apply').click(function() {
         ...
         if (bulk.val() == 'delete') {
             swal({
                 ...
                 function(isConfirm) {
                     if (isConfirm) {
                         document.location.href = BASE_URL + '/administrator/crud/delete?' + serialize_bulk;
                     }
                 });
