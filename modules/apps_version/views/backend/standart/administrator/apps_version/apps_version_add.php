...
<section class="content-header">
    <h1>
        App Version        <small><?= cclang('new', ['App Version']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['App Version']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="android_ver" id="android_ver" placeholder="Android" value="<?= set_value('android_ver'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ios_ver" id="ios_ver" placeholder="IOS" value="<?= set_value('ios_ver'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="release_note" name="release_note" rows="5" class="textarea form-control"><?= set_value('release_note'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/apps_version/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
