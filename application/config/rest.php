...
$config['auth_override_class_method']['mhcu']['export_individu_pdf'] = 'none';
$config['auth_override_class_method']['mhcu']['recalculate_mhcu_periode'] = 'none';
$config['auth_override_class_method']['mhcu']['recalculate_mhcu_sesi'] = 'none';
