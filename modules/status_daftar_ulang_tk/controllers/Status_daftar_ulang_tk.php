...
class Status_daftar_ulang_tk extends Admin
{
	...
	public function index($offset = 0)
	{
		...
		$this->data['status_daftar_ulang_tks'] = $this->model_status_daftar_ulang_tk->get($filter, $field, $this->limit_page, $offset);
		...
		$config = [
			...
			'total_rows'   => $this->model_status_daftar_ulang_tk->count_all($filter, $field),
		...
		if ($this->form_validation->run()) {
			...
			if ($this->input->post('status') == 1) {
				...
				if ($customPayment != '0' && $customPayment != '') {
					...
					$this->mymodel->update("status_daftar_ulang_tk", array("custom_payment" => $customPayment), "id_siswa_tk", $get_daftar_ulang->id_siswa_tk);
