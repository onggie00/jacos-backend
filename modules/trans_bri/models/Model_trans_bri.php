...
class Model_trans_bri extends MY_Model {

    private $primary_key    = 'id';
    private $table_name     = 'trans_bri';
    ...
    public function count_all($q = null, $field = null)
    {
        ...
        if (empty($field)) {
            foreach ($this->field_search as $field) {
                if ($iterasi == 1) {
                    $where .= "trans_bri.".$field . " LIKE '%" . $q . "%' ";
                } else {
                    $where .= "OR " . "trans_bri.".$field . " LIKE '%" . $q . "%' ";
                }
                $iterasi++;
            }
    ...
    public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
    {
        ...
        $this->db->limit($limit, $offset);
                $this->db->order_by('trans_bri.'.$this->primary_key, "DESC");
                $query = $this->db->get($this->table_name);
...
/* End of file Model_trans_bri.php */
/* Location: ./application/models/Model_trans_bri.php */