...
<section class="content-header">
    <h1>
        Rapor FT        <small><?= cclang('new', ['Rapor FT']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Rapor FT']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jenis_ujian" id="jenis_ujian" placeholder="Jenis Ujian" value="<?= set_value('jenis_ujian'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_ft_aktif_raport_file_raport_uuid" id="siswa_ft_aktif_raport_file_raport_uuid" type="hidden" value="<?= set_value('siswa_ft_aktif_raport_file_raport_uuid'); ?>">
                                <input class="data_file" name="siswa_ft_aktif_raport_file_raport_name" id="siswa_ft_aktif_raport_file_raport_name" type="hidden" value="<?= set_value('siswa_ft_aktif_raport_file_raport_name'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa_ft_aktif_raport/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_file_raport = $('#siswa_ft_aktif_raport_file_raport_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_raport !== 'undefined') {
                    $('#siswa_ft_aktif_raport_file_raport_galery').fineUploader('deleteFile', id_file_raport);
                }
