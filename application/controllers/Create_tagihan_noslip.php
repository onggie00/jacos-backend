...
class Create_tagihan_noslip extends REST_Controller
{
  ...
  public function index_post()
  {
    ...
    if($jenjang=='sd'){
      $msg = array('status' => 0, 'message'=>'Invalid Jenjang' ,'data'=>null);
      $status="200";
      $this->response($msg,$status);
    }else if($jenjang=='smp'){
      $code='60';
    ...
    if(!$payment_response['virtual_account']){
      $msg = array('status' => 0, 'message'=>'Terjadi Kesalahan Ketika Pembuatan VA' ,'data'=> null, 'errResponse' => $payment_response);
      $status="200";
