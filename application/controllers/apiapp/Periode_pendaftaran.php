...
class Periode_pendaftaran extends REST_Controller {
    ...
    public function index_get()
    {
      ...
      $id_siswa_aktif = $this->input->get("id_siswa_aktif");

        $data = $this->mymodel->withquery("select p.*, l.link_daftar_lain from web_periode_daftar p join web_link_daftar_lain l on p.id_web_periode_daftar = l.id","result");
