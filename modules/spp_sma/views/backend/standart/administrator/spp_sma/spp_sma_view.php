...
<section class="content-header">
   <h1>
      Spp Sma      <small><?= cclang('detail', ['Spp Sma']); ?> </small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Detail Spp Sma</h5>
                     <hr>
                  </div>

                 
                  <div class="form-horizontal" name="form_spp_sma" id="form_spp_sma" >
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($spp_sma->siswa_sma_aktif_nama_lengkap); ?>
                        </div>
                    </div>
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit spp_sma (Ctrl+e)" href="<?= site_url('administrator/spp_sma/edit/'.$spp_sma->id); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Spp Sma']); ?> </a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/spp_sma/'); ?>"><i class="fa fa-undo" ></i> <?= cclang('go_list_button', ['Spp Sma']); ?></a>
                     </div>
