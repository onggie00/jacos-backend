        ...
        if (!empty($cek)) {
            ...
            if (!empty($_FILES['file_pembayaran']['name'])) {
                ...
                if (move_uploaded_file($_FILES['file_pembayaran']['tmp_name'], $uploadfile)) {
                    ...
                    $this->mymodel->update("ekskul_member_".strtolower($jenjang), $data, "id_ekskul='".$id_ekskul."' and tahun_ajaran='".$tahun_ajaran."' and semester='".$semester."' and id_siswa=",$id_siswa);
