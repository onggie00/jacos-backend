...
<section class="content-header">
    <h1>
        Status Daftar Ulang TK        <small>Edit Status Daftar Ulang TK</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Status Daftar Ulang TK</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/status_daftar_ulang_tk/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_status_daftar_ulang_tk', 
                            'class'   => 'form-horizontal form-step', 
                            'id'      => 'form_status_daftar_ulang_tk', 
                            'method'  => 'POST'
                            ]); ?>
                         <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" value="<?= $status_daftar_ulang_tk->nama_lengkap?>" disabled>
                            </div>
                          </div>
                          <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input <?= $status_daftar_ulang_tk->status == "0" ? "checked" : ""; ?> type="radio" class="flat-red" id="status" name="status" value="0"> Menunggu Aktivasi                                    
                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input <?= $status_daftar_ulang_tk->status == "1" ? "checked" : ""; ?> type="radio" class="flat-red" id="status" name="status" value="1"> Aktivasi Virtual Account                                   
                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input <?= $status_daftar_ulang_tk->status == "2" ? "checked" : ""; ?> type="radio" class="flat-red" id="status" name="status" value="2"> Pembayaran Berhasil                                   
                                    </label>
                                    </div>
                          ...
                          <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="number" name="custom_total_payment" value="<?= ($status_daftar_ulang_tk->custom_payment)?$status_daftar_ulang_tk->custom_payment:0;?>">
                                <div class="row-fluid clear-both">
                                <small class="info help-block text-danger">
                        ...
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" disabled value="<?= $status_daftar_ulang_tk->va_bri?>">
                            </div>
                        </div>
                        <!-- Riwayat bri -->
                        <div class="form-group  wrapper-options-crud">
                        ...
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                              <div class="col-md-3 padding-left-0">
                                <label>
                                  <input <?= $status_daftar_ulang_tk->tipe_tagihan == "fixed" ? "checked" : ""; ?> type="radio" class="flat-red" id="tipe_tagihan" name="tipe_tagihan" value="fixed"> Fixed Payment
                                </label>
                              </div>
                              <div class="col-md-3 padding-left-0">
                                <label>
                                  <input <?= $status_daftar_ulang_tk->tipe_tagihan == "open" ? "checked" : ""; ?> type="radio" class="flat-red" id="tipe_tagihan" name="tipe_tagihan" value="open"> Open Payment
                                </label>
                              </div>
                            </div>
                        </div>
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                              <input class="form-control pull-right datetimepicker" type="text" name="end_date_va" id="end_date_va" value="<?= (!empty($status_daftar_ulang_tk->end_date_va)) ? date('Y-m-d', strtotime($status_daftar_ulang_tk->end_date_va)) : date('Y-m-d', strtotime('+1 month'));?>">
                              <div class="row-fluid clear-both">
                                <small class="info help-block text-danger">
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/status_daftar_ulang_tk';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_status_daftar_ulang_tk = $('#form_status_daftar_ulang_tk');
        var data_post = form_status_daftar_ulang_tk.serializeArray();
        ...
        $.ajax({
          url: form_status_daftar_ulang_tk.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#status_daftar_ulang_tk_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
