...
<section class="content-header">
    <h1>
        Pengaturan Url Presensi Siswa        <small><?= cclang('new', ['Pengaturan Url Presensi Siswa']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pengaturan Url Presensi Siswa']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <textarea id="url" name="url" rows="5" class="textarea form-control"><?= set_value('url'); ?></textarea>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pengaturan_url_presensi_siswa/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
