...
class Export_kartu_siswa_sementara extends MY_Controller {
    ...
    public function index()
    {
      ...
      if(isset($headers['user_role']))
        ...
        $datas['transaksi'] = $this->mymodel->withquery("select * from transaksi where no_transaksi like '%LDUI-".$tipe_siswa."%' and no_transaksi like '%-".$id_siswa."%'","row");
        ...
        $data->url_file = base_url('uploads/kartu_siswa_sementara/').$tipe_siswa.'-'.$data->no_peserta.'-'.$data->nama_lengkap.'.pdf';
