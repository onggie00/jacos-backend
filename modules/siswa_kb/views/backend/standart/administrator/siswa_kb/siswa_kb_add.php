...
<section class="content-header">
    <h1>
        Siswa KB <small><?= cclang('new', ['Siswa KB']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa KB']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_siswa_kb',
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_kb_foto_peserta_uuid" id="siswa_kb_foto_peserta_uuid" type="hidden" value="<?= set_value('siswa_kb_foto_peserta_uuid'); ?>">
                                <input class="data_file" name="siswa_kb_foto_peserta_name" id="siswa_kb_foto_peserta_name" type="hidden" value="<?= set_value('siswa_kb_foto_peserta_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_kb_akte_lahir_uuid" id="siswa_kb_akte_lahir_uuid" type="hidden" value="<?= set_value('siswa_kb_akte_lahir_uuid'); ?>">
                                <input class="data_file" name="siswa_kb_akte_lahir_name" id="siswa_kb_akte_lahir_name" type="hidden" value="<?= set_value('siswa_kb_akte_lahir_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_kb_kartu_keluarga_uuid" id="siswa_kb_kartu_keluarga_uuid" type="hidden" value="<?= set_value('siswa_kb_kartu_keluarga_uuid'); ?>">
                                <input class="data_file" name="siswa_kb_kartu_keluarga_name" id="siswa_kb_kartu_keluarga_name" type="hidden" value="<?= set_value('siswa_kb_kartu_keluarga_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select name="id_tingkatan" id="id_tingkatan" class="form-control">
                                    ...
                                    <option value="<?= $row->id_tingkatan_kb ?>" <?= set_select('id_tingkatan', $row->id_tingkatan_kb); ?>><?= $row->label ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                                    <b>Usia pendaftar divalidasi otomatis terhadap rentang usia tingkatan.</b>
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <div class="col-md-3 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="is_mutasi" value="1"> Ya </label>
                                </div>
                                <div class="col-md-3 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="is_mutasi" value="2"> Tidak </label>
                                </div>
                                </select>
                                <div class="row-fluid clear-both">
                                    <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kelas_mutasi" id="kelas_mutasi" placeholder="Kelas Mutasi" value="<?= set_value('kelas_mutasi'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="status_lulus" id="status_lulus" data-placeholder="Select Status Lulus">
                                    ...
                                    <?php foreach (db_get_all_data('status_lulus', ['id_status_lulus' => '2']) as $row) : ?>
                                        <option selected value="<?= $row->id_status_lulus ?>"><?= $row->status_lulus; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="va_number" id="va_number" placeholder="Virtual Account" value="<?= set_value('no_peserta'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa_kb/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
                .done(function(res) {
                    ...
                    if (res.success) {
                        var id_foto_peserta = $('#siswa_kb_foto_peserta_galery').find('li').attr('qq-file-id');
                        var id_akte_lahir = $('#siswa_kb_akte_lahir_galery').find('li').attr('qq-file-id');
                        var id_kartu_keluarga = $('#siswa_kb_kartu_keluarga_galery').find('li').attr('qq-file-id');
                        ...
                        if (typeof id_foto_peserta !== 'undefined') {
                            $('#siswa_kb_foto_peserta_galery').fineUploader('deleteFile', id_foto_peserta);
                        }
                        if (typeof id_akte_lahir !== 'undefined') {
                            $('#siswa_kb_akte_lahir_galery').fineUploader('deleteFile', id_akte_lahir);
                        }
                        if (typeof id_kartu_keluarga !== 'undefined') {
                            $('#siswa_kb_kartu_keluarga_galery').fineUploader('deleteFile', id_kartu_keluarga);
                        }
