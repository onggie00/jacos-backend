...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="{php_open_tag_echo} site_url('administrator/manage-form/{table_name}'); {php_close_tag}"><?= ucwords(clean_snake_case($subject)); ?></a></li>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/manage-form/{table_name}';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/manage-form/{table_name}/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
       ...
       $('#{table_name}_<?= $input; ?>_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/manage-form/{table_name}/upload_<?= $input; ?>_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: BASE_URL + '/administrator/manage-form/{table_name}/delete_<?= $input; ?>_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/manage-form/{table_name}/delete_<?= $input; ?>_file/' + uuid);
              },
