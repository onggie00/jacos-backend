...
<section class="content-header">
    <h1>
        Presensi Pelatih SD        <small><?= cclang('new', ['Presensi Pelatih SD']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Presensi Pelatih SD']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_presensi_pelatih_sd/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
