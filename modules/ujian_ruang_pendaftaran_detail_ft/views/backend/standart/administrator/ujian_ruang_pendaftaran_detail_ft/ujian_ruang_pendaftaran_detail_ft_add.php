...
<section class="content-header">
    <h1>
        Detail Peserta Ujian PSB FT        <small><?= cclang('new', ['Detail Peserta Ujian PSB FT']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Detail Peserta Ujian PSB FT']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-8">
                                <select multiple class="form-control chosen chosen-select-deselect" name="nomor_peserta[]" id="nomor_peserta" data-placeholder="Select Nomor Peserta" >
                                    <option value=""></option>
                                    <?php foreach ($this->mymodel->withquery("select no_peserta, nama_lengkap from siswa_ft where no_peserta != '' order by no_peserta ASC", "result") as $row): ?>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ujian_ruang_pendaftaran_detail_ft/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
