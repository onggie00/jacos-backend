...
<section class="content-header">
    <h1>
        Foto Pengajar        <small><?= cclang('new', ['Foto Pengajar']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Foto Pengajar']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="foto_pengajar_foto_uuid" id="foto_pengajar_foto_uuid" type="hidden" value="<?= set_value('foto_pengajar_foto_uuid'); ?>">
                                <input class="data_file" name="foto_pengajar_foto_name" id="foto_pengajar_foto_name" type="hidden" value="<?= set_value('foto_pengajar_foto_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/foto_pengajar/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_foto = $('#foto_pengajar_foto_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_foto !== 'undefined') {
                    $('#foto_pengajar_foto_galery').fineUploader('deleteFile', id_foto);
                }
