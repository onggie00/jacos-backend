...
class Get_ptn_tahun_ajaran extends REST_Controller {
    ...
    public function index_get()
    {
        ...
        $data = $this->second_db->withquery("select tahun_ajaran from pt_to_siswa where tahun_ajaran != '' and tahun_ajaran IS NOT NULL group by tahun_ajaran order by tahun_ajaran DESC","result");
