...
class Permintaan_pengajuan extends REST_Controller {
    ...
    public function index_get()
    {
      ...
      if(isset($headers['x-token']))
        ...
        $data = $this->mymodel->withquery("select * from presensi_office_submission where head_role = '".$role."' ".$where." order by id_submission DESC","result",$bindings);
