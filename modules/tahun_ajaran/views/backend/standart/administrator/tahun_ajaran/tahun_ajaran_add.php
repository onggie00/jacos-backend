...
<section class="content-header">
    <h1>
        Tahun Ajaran        <small><?= cclang('new', ['Tahun Ajaran']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tahun Ajaran']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_tahun_ajaran', 
                            'class'   => 'form-horizontal form-step', 
                            'id'      => 'form_tahun_ajaran', 
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/tahun_ajaran';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_tahun_ajaran = $('#form_tahun_ajaran');
        var data_post = form_tahun_ajaran.serializeArray();
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tahun_ajaran/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
