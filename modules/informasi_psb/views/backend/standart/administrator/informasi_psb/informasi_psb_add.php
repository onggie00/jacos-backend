...
<section class="content-header">
    <h1>
        Informasi Psb        <small><?= cclang('new', ['Informasi Psb']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Informasi Psb']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="thumbnail" id="thumbnail" placeholder="Thumbnail" value="<?= set_value('thumbnail'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="foto_informasi" id="foto_informasi" placeholder="Foto Informasi" value="<?= set_value('foto_informasi'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/informasi_psb/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
