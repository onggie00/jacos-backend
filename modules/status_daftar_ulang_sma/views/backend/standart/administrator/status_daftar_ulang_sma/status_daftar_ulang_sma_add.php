...
<section class="content-header">
    <h1>
        Status Daftar Ulang Sma        <small><?= cclang('new', ['Status Daftar Ulang Sma']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Status Daftar Ulang Sma']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="id_siswa_sma" id="id_siswa_sma" placeholder="Id Siswa Sma" value="<?= set_value('id_siswa_sma'); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                <b>Input Status</b> Max Length : 6.</small>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/status_daftar_ulang_sma/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
