...
<head>
  ...
  <title><?= (!empty(get_user_first_group()->name) ? get_user_first_group()->name." |" : "") ?> <?= get_option('site_name'); ?> | <?= $template['title']; ?></title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="padding-top:0% !important">
      <ul class="sidebar-menu  sidebar-admin tree">
