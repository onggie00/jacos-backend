...
defined('VERSION')              OR define('VERSION', '3.1.0'); // highest automatically-assigned error code
...
// MHCU Care — salt token auto-login publik (mhcu_care?token=md5(id_sesi . salt)&id_sesi=)
defined('MHCU_CARE_TOKEN_SALT') OR define('MHCU_CARE_TOKEN_SALT', 'MhcuCare@Labschool#2026!care');
