...
class Upload_pembayaran_ekskul extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        $cek = $this->mymodel->withquery("select * from ekskul_member_".$jenjang." where id_siswa = '".$id_siswa."' and id_ekskul = '".$id_ekskul."' order by id_member desc", "row");
        ...
        if (!empty($cek)) {
            ...
            $msg = array('status' => 200, 'message'=>'Berhasil Unggah File, menunggu approval dari pembina' ,'data'=>$data);
        }
        else{
