...
<section class="content-header">
    <h1>
        Galeri Foto        <small><?= cclang('new', ['Galeri Foto']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Galeri Foto']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="galeri_foto_foto_uuid" id="galeri_foto_foto_uuid" type="hidden" value="<?= set_value('galeri_foto_foto_uuid'); ?>">
                                <input class="data_file" name="galeri_foto_foto_name" id="galeri_foto_foto_name" type="hidden" value="<?= set_value('galeri_foto_foto_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/galeri_foto/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_foto = $('#galeri_foto_foto_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_foto !== 'undefined') {
                    $('#galeri_foto_foto_galery').fineUploader('deleteFile', id_foto);
                }
