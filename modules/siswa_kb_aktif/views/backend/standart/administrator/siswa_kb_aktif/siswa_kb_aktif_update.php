...
<section class="content-header">
    <h1>
        Siswa KB Aktif        <small>Edit Siswa KB Aktif</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Siswa KB Aktif</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/siswa_kb_aktif/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?= set_value('nama_lengkap', $siswa_kb_aktif->nama_lengkap); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nis" id="nis" placeholder="Nis" value="<?= set_value('nis', $siswa_kb_aktif->nis); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_kelas" id="id_kelas" data-placeholder="Select Id Kelas" >
                                    ...
                                    <option <?=  $row->id_kelas_kb ==  $siswa_kb_aktif->id_kelas ? 'selected' : ''; ?> value="<?= $row->id_kelas_kb ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                <b>Input  Kelas</b> Max Length : 11.</small>
                                                ...
                                                <div class="form-group ">
                            <label for="id_siswa_kb" class="col-sm-2 control-label"> Siswa KB 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_kb" id="id_siswa_kb" data-placeholder="Select Id Siswa KB" >
                                    ...
                                    <option <?=  $row->id_siswa_kb ==  $siswa_kb_aktif->id_siswa_kb ? 'selected' : ''; ?> value="<?= $row->id_siswa_kb ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_tahun_ajaran" id="id_tahun_ajaran" data-placeholder="Select Id Tahun Ajaran" >
                                    ...
                                    <option <?=  $row->id_tahun_ajaran ==  $siswa_kb_aktif->id_tahun_ajaran ? 'selected' : ''; ?> value="<?= $row->id_tahun_ajaran ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomor_peserta_ujian" id="nomor_peserta_ujian" placeholder="nomor_peserta_ujian" value="<?= set_value('nomor_peserta_ujian', $siswa_kb_aktif->nomor_peserta_ujian); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kewarganegaraan" id="kewarganegaraan" placeholder="Kewarganegaraan" value="<?= set_value('kewarganegaraan', $siswa_kb_aktif->kewarganegaraan); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nik" id="nik" placeholder="Nik" value="<?= set_value('nik', $siswa_kb_aktif->nik); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="golongan_darah" id="golongan_darah" placeholder="Golongan Darah" value="<?= set_value('golongan_darah', $siswa_kb_aktif->golongan_darah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="telp" id="telp" placeholder="Telp" value="<?= set_value('telp', $siswa_kb_aktif->telp); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pendidikan_ayah" id="pendidikan_ayah" placeholder="Pendidikan Ayah" value="<?= set_value('pendidikan_ayah', $siswa_kb_aktif->pendidikan_ayah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pendidikan_ibu" id="pendidikan_ibu" placeholder="Pendidikan Ibu" value="<?= set_value('pendidikan_ibu', $siswa_kb_aktif->pendidikan_ibu); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="penghasilan_ayah" id="penghasilan_ayah" placeholder="Penghasilan Ayah" value="<?= set_value('penghasilan_ayah', $siswa_kb_aktif->penghasilan_ayah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="penghasilan_ibu" id="penghasilan_ibu" placeholder="Penghasilan Ibu" value="<?= set_value('penghasilan_ibu', $siswa_kb_aktif->penghasilan_ibu); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tgl_lahir_ayah" id="tgl_lahir_ayah" placeholder="Tgl Lahir Ayah" value="<?= set_value('tgl_lahir_ayah', $siswa_kb_aktif->tgl_lahir_ayah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tgl_lahir_ibu" id="tgl_lahir_ibu" placeholder="Tgl Lahir Ibu" value="<?= set_value('tgl_lahir_ibu', $siswa_kb_aktif->tgl_lahir_ibu); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="spp_custom_display" id="spp_custom_display" placeholder="SPP khusus" value="<?= set_value('spp_custom', $siswa_kb_aktif->spp_custom); ?>" oninput="formatRupiah(this)">
                                <input type="hidden" name="spp_custom" id="spp_custom" value="<?= set_value('spp_custom', $siswa_kb_aktif->spp_custom); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select" name="spp_type" id="spp_type">
                                    <option <?= ($siswa_kb_aktif->spp_type == 'FULL') ? 'selected' : ''; ?> value="FULL">FULL</option>
                                    <option <?= ($siswa_kb_aktif->spp_type == 'HALF') ? 'selected' : ''; ?> value="HALF">HALF (50%)</option>
                                    <option <?= ($siswa_kb_aktif->spp_type == 'FREE') ? 'selected' : ''; ?> value="FREE">FREE (Rp 0)</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select" name="acc_ujian" id="acc_ujian">
                                    <option <?= ($siswa_kb_aktif->acc_ujian == 1 || empty($siswa_kb_aktif->acc_ujian)) ? 'selected' : ''; ?> value="1">Boleh</option>
                                    <option <?= ($siswa_kb_aktif->acc_ujian == 0) ? 'selected' : ''; ?> value="0">Tidak Boleh</option>
                                </select>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email_ms_office" id="email_ms_office" placeholder="Email Office" value="<?= set_value('email_ms_office', $siswa_kb_aktif->email_ms_office); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email_ms_office_ortu" id="email_ms_office_ortu" placeholder="Email Office Ortu" value="<?= set_value('email_ms_office_ortu', $siswa_kb_aktif->email_ms_office_ortu); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <?php if (!empty($siswa_kb_aktif->deleted_at_siswa)): ?>
                                    <div style="padding:10px;background:#fde8e8;border:1px solid #e74c3c;border-radius:4px;margin-bottom:8px">
                                        ...
                                        <small class="text-danger"><i class="fa fa-calendar"></i> Dihapus pada: <?= date('d M Y H:i', strtotime($siswa_kb_aktif->deleted_at_siswa)); ?></small>
                                    </div>
                            ...
                            <div class="col-sm-8">
                                <?php if (!empty($siswa_kb_aktif->deleted_at_ortu)): ?>
                                    <div style="padding:10px;background:#fde8e8;border:1px solid #e74c3c;border-radius:4px;margin-bottom:8px">
                                        ...
                                        <small class="text-danger"><i class="fa fa-calendar"></i> Dihapus pada: <?= date('d M Y H:i', strtotime($siswa_kb_aktif->deleted_at_ortu)); ?></small>
                                    </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_siswa_kb_aktif.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#siswa_kb_aktif_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
