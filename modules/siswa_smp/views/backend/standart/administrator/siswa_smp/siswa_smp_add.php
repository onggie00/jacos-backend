...
<section class="content-header">
    <h1>
        Siswa SMP        <small><?= cclang('new', ['Siswa SMP']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa SMP']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_siswa_smp', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email_ms_office_ortu" id="email_ms_office_ortu" placeholder="Email Ms. Office Ortu" value="<?= set_value('email_ms_office_ortu'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_smp_foto_peserta_uuid" id="siswa_smp_foto_peserta_uuid" type="hidden" value="<?= set_value('siswa_smp_foto_peserta_uuid'); ?>">
                                <input class="data_file" name="siswa_smp_foto_peserta_name" id="siswa_smp_foto_peserta_name" type="hidden" value="<?= set_value('siswa_smp_foto_peserta_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_smp_akte_lahir_uuid" id="siswa_smp_akte_lahir_uuid" type="hidden" value="<?= set_value('siswa_smp_akte_lahir_uuid'); ?>">
                                <input class="data_file" name="siswa_smp_akte_lahir_name" id="siswa_smp_akte_lahir_name" type="hidden" value="<?= set_value('siswa_smp_akte_lahir_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_smp_kartu_keluarga_uuid" id="siswa_smp_kartu_keluarga_uuid" type="hidden" value="<?= set_value('siswa_smp_kartu_keluarga_uuid'); ?>">
                                <input class="data_file" name="siswa_smp_kartu_keluarga_name" id="siswa_smp_kartu_keluarga_name" type="hidden" value="<?= set_value('siswa_smp_kartu_keluarga_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_transaksi" id="no_transaksi" placeholder="Nomor Transaksi" value="<?= set_value('no_transaksi'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div> -->
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="jenis_ppsbb" id="jenis_ppsbb" data-placeholder="Select Jenis PPSBB" >
                                    <option value=""></option>
                                    <option value="3">Non PPSBB</option>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa_smp/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_foto_peserta = $('#siswa_smp_foto_peserta_galery').find('li').attr('qq-file-id');
            var id_akte_lahir = $('#siswa_smp_akte_lahir_galery').find('li').attr('qq-file-id');
            var id_kartu_keluarga = $('#siswa_smp_kartu_keluarga_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_foto_peserta !== 'undefined') {
                    $('#siswa_smp_foto_peserta_galery').fineUploader('deleteFile', id_foto_peserta);
                }
            if (typeof id_akte_lahir !== 'undefined') {
                    $('#siswa_smp_akte_lahir_galery').fineUploader('deleteFile', id_akte_lahir);
                }
            if (typeof id_kartu_keluarga !== 'undefined') {
                    $('#siswa_smp_kartu_keluarga_galery').fineUploader('deleteFile', id_kartu_keluarga);
                }
