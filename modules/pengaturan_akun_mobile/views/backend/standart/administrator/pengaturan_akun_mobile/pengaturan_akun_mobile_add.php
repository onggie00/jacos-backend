...
<section class="content-header">
    <h1>
        Pengaturan Akun Mobile        <small><?= cclang('new', ['Pengaturan Akun Mobile']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pengaturan Akun Mobile']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <textarea id="secret_key" name="secret_key" rows="5" class="textarea form-control"><?= set_value('secret_key'); ?></textarea>
                            ...
                            <div class="col-sm-8">
                                <textarea id="client_key" name="client_key" rows="5" class="textarea form-control"><?= set_value('client_key'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="value" name="value" rows="5" class="textarea form-control"><?= set_value('value'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="expired_date"  id="expired_date">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/pengaturan_akun_mobile/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
