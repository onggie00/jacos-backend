...
<div class="login-box">
  ...
  <div class="login-box-body">
   ...
   <div class="callout callout-<?= $type; ?>"  style="color:#C82626">
    ...
    <a href="<?= site_url('oauth/v/google'); ?>" class="btn btn-block btn-social btn-google btn-flat" style="display:none;"><i class="fa fa-google"></i> <?= cclang('sign_in_using') ?> Google+</a>
