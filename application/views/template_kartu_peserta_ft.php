    ...
    <div id="divid">
        <table border="0" style="margin-top: 10px;margin-left: 40px;font-family: arial;">
            <tr>
                ...
                <span style="font-size: 12pt;">TAHUN PELAJARAN <span style="color: black;"><?= $tahun_ajaran_psb; ?></span></span></td>
            ...
            <tr>
                <td>
                    <table border="0" style="margin-left: 40px;">
                        <tr>
                            <td style="width:160px;border: 3px solid black;font-size: 14pt;font-weight:bold;padding: 10px 0px 10px 20px;font-family: times;"  ><span style="text-decoration: underline;">Lokasi Tes :</span><br/><span style="font-size: 14pt;"><?= (!empty($data_ruang_ujian->lokasi_ujian))  ? $data_ruang_ujian->lokasi_ujian : "-"; ?></span></td>
                        </tr>
                    </table>
                </td>
                <td>
                    <table border="0" style="margin-left: 5px;">
                        <tr>
                            <td style="width:125px;border: 3px solid black;font-size: 14pt;font-weight:bold;padding: 10px 20px;font-family: times;"  ><span style="text-decoration: underline;">Ruang :</span><br/><span style="font-size: 14pt;"><?= (!empty($data_ruang_ujian->nama_ruang))  ? $data_ruang_ujian->nama_ruang : "-"; ?></span></td>
                        </tr>
                    </table>
                </td>
                <td>
                    <table border="0" style="margin-left: 5px;">
                        <tr>
                            <td style="width:125px;border: 3px solid black;font-size: 14pt;font-weight:bold;padding: 10px 20px;font-family: times;"  ><span style="text-decoration: underline;">No. Peserta :</span><br/><span style="font-size: 14pt;"><?php echo $siswa->no_peserta; ?></span></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table border="0" style="margin-left: 40px;">
            <tr>
                <td style="height:200px;vertical-align: top;padding: 10px 10px;" rowspan="2">
                    <table border="0">
                        <tr>
                            ...
                            <td><img style="width: 140px; height: 200px; object-fit: fill; image-orientation:none;" src="<?php echo FCPATH . '/uploads/siswa_'.$tipe_siswa.'/'.$siswa->foto_peserta; ?>" /></td>
                        </tr>
                    </table>
                </td>
                <td style="padding: 10px 10px; font-size: 12pt;">
                    <table border="0">
                        <tr>
                            <td colspan="3" style="font-size: 14pt;font-weight: bold;font-family: times;text-transform: uppercase;"><?php echo $siswa->nama_lengkap; ?></td>
                        </tr>
                        <tr>
                    ...
                    <table border="0">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo $siswa->password_ujian;//$siswa->password_ujian; ?></td>
                        </tr>
                        <tr>
