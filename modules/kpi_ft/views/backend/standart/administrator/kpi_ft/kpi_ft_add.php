...
<section class="content-header">
    <h1>
        Kpi Ft        <small><?= cclang('new', ['Kpi Ft']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kpi Ft']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_kpi_ft', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="kpi_ft_file_piagam_uuid" id="kpi_ft_file_piagam_uuid" type="hidden" value="<?= set_value('kpi_ft_file_piagam_uuid'); ?>">
                                <input class="data_file" name="kpi_ft_file_piagam_name" id="kpi_ft_file_piagam_name" type="hidden" value="<?= set_value('kpi_ft_file_piagam_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/kpi_ft/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_file_piagam = $('#kpi_ft_file_piagam_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_piagam !== 'undefined') {
                    $('#kpi_ft_file_piagam_galery').fineUploader('deleteFile', id_file_piagam);
                }
