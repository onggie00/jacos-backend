...
<section class="content-header">
   <h1><i class="fa fa-university"></i> <?= cclang('list_sekolah_smp') ?> <small class="labs-text-muted"><?= cclang('list_all'); ?></small></h1>
   <ol class="breadcrumb"><li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li><li class="active"><?= cclang('list_sekolah_smp') ?></li></ol>
</section>
            ...
            <div class="col-md-4">
               <div class="labs-stat-card">
                  ...
                  <div class="labs-stat-card__body">
                     ...
                     <div class="labs-stat-card__value" data-counter="<?= (int)$list_sekolah_smp_counts; ?>">0</div>
                  </div>
               </div>
            </div>
            <div class="col-md-4">
         ...
         <div class="labs-card">
            ...
            <div class="labs-card__header">
               <h3 class="labs-card__title">
                  <i class="fa fa-list"></i> Daftar Sekolah SMP
                  <span class="labs-badge labs-badge--orange"><?= $list_sekolah_smp_counts; ?> Data</span>
               </h3>
               <div>
                  <?php is_allowed('list_sekolah_smp_add', function(){?>
                  <a class="labs-btn labs-btn--success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('list_sekolah_smp')]); ?> (Ctrl+a)" href="<?= site_url('administrator/list_sekolah_smp/add'); ?>">
                     <i class="fa fa-plus"></i> <?= cclang('add_new_button', [cclang('list_sekolah_smp')]); ?>
                  </a>
                  <?php }) ?>
                  <?php is_allowed('list_sekolah_smp_delete', function(){?>
            ...
            <div class="labs-card__body">
               ...
               <!-- Filter Bar -->
               <form name="form_list_sekolah_smp" id="form_list_sekolah_smp" action="<?= base_url('administrator/list_sekolah_smp/index'); ?>">
               <div class="labs-filter-inline">
                  ...
                  <a class="labs-btn labs-btn--default" href="<?= base_url('administrator/list_sekolah_smp'); ?>"><i class="fa fa-undo"></i> Reset</a>
                  <?php endif; ?>
               </div>

               <!-- Data Table -->
               <div class="labs-table-wrap">
                  <table class="labs-table dataTable" id="list_sekolah_smp_table">
                     <thead>
                        <tr>
                     ...
                     <tbody id="tbody_list_sekolah_smp">
                     <?php if($list_sekolah_smp_counts > 0): ?>
                     <?php foreach($list_sekolah_smps as $list_sekolah_smp): ?>
                        <tr>
                           <td class="labs-text-center">
                              <input type="checkbox" class="flat-red check" name="id[]" value="<?= $list_sekolah_smp->id_list_sekolah_smp; ?>">
                           </td>
                           <td>
                              <div class="labs-name-cell">
                                 <span class="labs-avatar labs-avatar--sm" data-name="<?= _ent($list_sekolah_smp->nama_sekolah); ?>"></span>
                                 <span class="labs-fw-semi"><?= _ent($list_sekolah_smp->nama_sekolah); ?></span>
                              </div>
                           </td>
                           <td><span class="labs-text-muted"><?= _ent($list_sekolah_smp->no_sekolah); ?></span></td>
                           <td>
                              <?php
                                 $ns = strtolower($list_sekolah_smp->negeri_swasta);
                                 if ($ns == 'negeri') {
                                    echo '<span class="labs-badge labs-badge--success labs-badge--solid">NEGERI</span>';
                                 } elseif ($ns == 'swasta') {
                                    echo '<span class="labs-badge labs-badge--warning labs-badge--solid">SWASTA</span>';
                                 } else {
                                    echo '<span class="labs-badge labs-badge--default">' . _ent($list_sekolah_smp->negeri_swasta) . '</span>';
                                 }
                              ?>
                           </td>
                           <td>
                              <?php if(!empty($list_sekolah_smp->lokasi)): ?>
                                 <i class="fa fa-map-marker labs-text-primary"></i> <?= _ent($list_sekolah_smp->lokasi); ?>
                              <?php else: ?>
                                 <span class="labs-text-light">-</span>
                              <?php endif; ?>
                           </td>
                           <td>
                              <?php if(!empty($list_sekolah_smp->akreditasi)): ?>
                                 <span class="labs-badge labs-badge--info"><?= _ent($list_sekolah_smp->akreditasi); ?></span>
                              <?php else: ?>
                                 <span class="labs-text-light">-</span>
                              <?php endif; ?>
                           </td>
                           <td>
                              <?php if($list_sekolah_smp->is_show == 1): ?>
                                 <span class="labs-badge labs-badge--success"><i class="fa fa-check"></i> Aktif</span>
                              <?php else: ?>
                           ...
                           <td style="text-align:center;white-space:nowrap">
                              <div class="labs-row-actions" style="justify-content:center">
                                 <?php is_allowed('list_sekolah_smp_view', function() use ($list_sekolah_smp){?>
                                 <a href="<?= site_url('administrator/list_sekolah_smp/view/' . $list_sekolah_smp->id_list_sekolah_smp); ?>" class="labs-btn labs-btn--info labs-btn--sm" title="<?= cclang('view_button'); ?>">
                                    <i class="fa fa-eye"></i>
                                 </a>
                                 <?php }) ?>
                                 <?php is_allowed('list_sekolah_smp_update', function() use ($list_sekolah_smp){?>
                                 <a href="<?= site_url('administrator/list_sekolah_smp/edit/' . $list_sekolah_smp->id_list_sekolah_smp); ?>" class="labs-btn labs-btn--warning labs-btn--sm" title="<?= cclang('update_button'); ?>">
                                    <i class="fa fa-edit"></i>
                                 </a>
                                 <?php }) ?>
                                 <?php is_allowed('list_sekolah_smp_delete', function() use ($list_sekolah_smp){?>
                                 <a href="javascript:void(0);" data-href="<?= site_url('administrator/list_sekolah_smp/delete/' . $list_sekolah_smp->id_list_sekolah_smp); ?>" class="labs-btn labs-btn--danger labs-btn--sm remove-data" title="<?= cclang('remove_button'); ?>">
                        ...
                        <tr>
                           <td colspan="8">
                              <div class="labs-empty">
                                 ...
                                 <?php else: ?>
                                    <p>Daftar Sekolah SMP belum tersedia</p>
                                 <?php endif; ?>
                              </div>
                           </td>
                        </tr>
               ...
               <div class="labs-flex-between labs-mt-4">
                  <div class="labs-flex labs-flex-gap-2" style="align-items:center">
                     ...
                     <span class="labs-text-muted labs-fs-sm">Total: <strong><?= $list_sekolah_smp_counts; ?></strong> data</span>
                  </div>
...
$(document).ready(function(){
   ...
   $('.btn_delete_all').click(function(){
      swal({
          ...
          text: "Tindakan ini akan MENGHAPUS SEMUA data list_sekolah_smp. Tindakan ini tidak dapat dibatalkan.",
          type: "warning",
        ...
        function(isConfirm){
          if (isConfirm) {
            ...
            function(inputValue){
              if (inputValue === "HAPUS") {
                document.location.href = BASE_URL + '/administrator/list_sekolah_smp/delete_all?confirm=yes';
   ...
   $('#apply').click(function(){
      var bulk = $('#bulk');
      var serialize_bulk = $('#form_list_sekolah_smp').serialize();
      if (bulk.val() == 'delete') {
         swal({
            title: "<?= cclang('are_you_sure'); ?>",
            text: "<?= cclang('data_to_be_deleted_can_not_be_restored'); ?>",
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/list_sekolah_smp/delete?' + serialize_bulk;
            }
          });
        return false;
      } else if(bulk.val() == '')  {
