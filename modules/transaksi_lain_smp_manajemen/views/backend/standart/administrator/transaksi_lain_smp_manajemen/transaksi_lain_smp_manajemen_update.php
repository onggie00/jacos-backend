...
<section class="content-header">
    <h1>
        Manajemen Tagihan SMP        <small>Edit Manajemen Tagihan SMP</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Manajemen Tagihan SMP</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/transaksi_lain_smp_manajemen/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_kategori" id="id_kategori" data-placeholder="Select Kategori" >
                                    ...
                                    <option <?=  $row->id_kategori ==  $transaksi_lain_smp_manajemen->id_kategori ? 'selected' : ''; ?> value="<?= $row->id_kategori ?>"><?= $row->nama_kategori; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_transaksi" id="nama_transaksi" placeholder="Nama Tagihan" value="<?= set_value('nama_transaksi', $transaksi_lain_smp_manajemen->nama_transaksi); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="keterangan" name="keterangan" rows="10" cols="80"> <?= set_value('keterangan', $transaksi_lain_smp_manajemen->keterangan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nominal" id="nominal" placeholder="Nominal" value="<?= set_value('nominal', $transaksi_lain_smp_manajemen->nominal); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_tahun_ajaran" id="id_tahun_ajaran" data-placeholder="Select Tahun Ajaran" >
                                    ...
                                    <option <?=  $row->id_tahun_ajaran ==  $transaksi_lain_smp_manajemen->id_tahun_ajaran ? 'selected' : ''; ?> value="<?= $row->id_tahun_ajaran ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_tingkatan" id="id_tingkatan" data-placeholder="Select Tingkatan" >
                                    ...
                                    <option <?=  $row->id_tingkatan_smp ==  $transaksi_lain_smp_manajemen->id_tingkatan ? 'selected' : ''; ?> value="<?= $row->id_tingkatan_smp ?>"><?= $row->label; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="id_kelas[]" id="id_kelas" data-placeholder="Select Kelas" multiple >
                                    ...
                                    <option <?=  in_array($row->id_kelas_smp, explode(',', $transaksi_lain_smp_manajemen->id_kelas)) ? 'selected' : ''; ?> value="<?= $row->id_kelas_smp ?>"><?= $row->nama_kelas; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="id_siswa[]" id="id_siswa" data-placeholder="Select Siswa" multiple >
                                    ...
                                    <option <?=  in_array($row->id_siswa_smp_aktif, explode(',', $transaksi_lain_smp_manajemen->id_siswa)) ? 'selected' : ''; ?> value="<?= $row->id_siswa_smp_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="tanggal_tagihan_mulai"  placeholder="Tagihan Mulai" id="tanggal_tagihan_mulai" value="<?= set_value('tanggal_tagihan_mulai', $transaksi_lain_smp_manajemen->tanggal_tagihan_mulai); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="tanggal_tagihan_selesai"  placeholder="Tagihan Selesai" id="tanggal_tagihan_selesai" value="<?= set_value('tanggal_tagihan_selesai', $transaksi_lain_smp_manajemen->tanggal_tagihan_selesai); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="tipe_bank" id="tipe_bank" data-placeholder="Select Bank" >
                                    <option value=""></option>
                                    <option <?= $transaksi_lain_smp_manajemen->tipe_bank == "BNI" ? 'selected' :''; ?> value="BNI">BNI</option>
                                    <option <?= $transaksi_lain_smp_manajemen->tipe_bank == "BRI" ? 'selected' :''; ?> value="BRI">BRI</option>
                                    </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_transaksi_lain_smp_manajemen.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#transaksi_lain_smp_manajemen_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
