...
class Get_presensi_ekskul extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        $data = $this->second_db->withquery("select p.*, s.nama_lengkap, k.label as nama_kelas, k.id_tingkatan, s.id_kelas from ".$nama_tabel." p join siswa_".$jenjang."_aktif s on p.id_siswa_aktif = s.id_siswa_".$jenjang."_aktif join kelas_".$jenjang." k on s.id_kelas = k.id_kelas_".$jenjang." ".$where." order by p.tanggal_absen ASC","result");
