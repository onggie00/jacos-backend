...
<section class="content-header">
    <h1>
        Izin SD        <small>Edit Izin SD</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Izin SD</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/izin_siswa_sd/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_aktif" id="id_siswa_aktif" data-placeholder="Select Siswa Aktif" >
                                    ...
                                    <option <?=  $row->id_siswa_sd_aktif ==  $izin_siswa_sd->id_siswa_aktif ? 'selected' : ''; ?> value="<?= $row->id_siswa_sd_aktif ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_mulai"  placeholder="Tanggal Mulai" id="tanggal_mulai" value="<?= set_value('izin_siswa_sd_tanggal_mulai_name', $izin_siswa_sd->tanggal_mulai); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_selesai"  placeholder="Tanggal Selesai" id="tanggal_selesai" value="<?= set_value('izin_siswa_sd_tanggal_selesai_name', $izin_siswa_sd->tanggal_selesai); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="izin_siswa_sd_file_izin_uuid" id="izin_siswa_sd_file_izin_uuid" type="hidden" value="<?= set_value('izin_siswa_sd_file_izin_uuid'); ?>">
                                <input class="data_file" name="izin_siswa_sd_file_izin_name" id="izin_siswa_sd_file_izin_name" type="hidden" value="<?= set_value('izin_siswa_sd_file_izin_name', $izin_siswa_sd->file_izin); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" value="<?= set_value('keterangan', $izin_siswa_sd->keterangan); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="jenis_izin" id="jenis_izin" data-placeholder="Select Jenis Izin" >
                                    <option value=""></option>
                                    <option <?= $izin_siswa_sd->jenis_izin == "SAKIT" ? 'selected' :''; ?> value="SAKIT">SAKIT</option>
                                    <option <?= $izin_siswa_sd->jenis_izin == "IZIN" ? 'selected' :''; ?> value="IZIN">IZIN</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="status" id="status" data-placeholder="Select Status" >
                                    <option value=""></option>
                                    <option <?= $izin_siswa_sd->status == "pending" ? 'selected' :''; ?> value="pending">Menunggu Persetujuan</option>
                                    <option <?= $izin_siswa_sd->status == "diterima" ? 'selected' :''; ?> value="diterima">Pengajuan Diterima</option>
                                    <option <?= $izin_siswa_sd->status == "ditolak" ? 'selected' :''; ?> value="ditolak">Pengajuan Ditolak</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_approver" id="id_approver" data-placeholder="Select Approver" >
                                    ...
                                    <option <?=  $row->id_guru ==  $izin_siswa_sd->id_approver ? 'selected' : ''; ?> value="<?= $row->id_guru ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_izin_siswa_sd.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#izin_siswa_sd_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#izin_siswa_sd_file_izin_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/izin_siswa_sd/get_file_izin_file/<?= $izin_siswa_sd->id; ?>',
