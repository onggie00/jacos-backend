...
<section class="content-header">
    <h1>
        Pengaturan Popup Banner        <small><?= cclang('new', ['Pengaturan Popup Banner']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Pengaturan Popup Banner']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="apps_banner_img_file_uuid" id="apps_banner_img_file_uuid" type="hidden" value="<?= set_value('apps_banner_img_file_uuid'); ?>">
                                <input class="data_file" name="apps_banner_img_file_name" id="apps_banner_img_file_name" type="hidden" value="<?= set_value('apps_banner_img_file_name'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_urut" id="no_urut" placeholder="Urutan" value="<?= set_value('no_urut'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/apps_banner/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_img_file = $('#apps_banner_img_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_img_file !== 'undefined') {
                    $('#apps_banner_img_file_galery').fineUploader('deleteFile', id_img_file);
                }
