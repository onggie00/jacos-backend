...
class Model_laporan_tka_guru_smp extends MY_Model {

    private $primary_key    = 'id_laporan';
    private $table_name     = 'laporan_tka_guru_smp';
    ...
    public function join_avaiable() {
        ...
        $this->db->select($this->table_name.'.*, '.$this->nama_expr().' as guru_smp_nama_lengkap, '.$this->npp_expr().' as npp');
        return $this;
    }
