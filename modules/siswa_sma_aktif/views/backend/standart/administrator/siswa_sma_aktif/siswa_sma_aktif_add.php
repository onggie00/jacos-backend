                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa Sma Aktif']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                         ...
                         <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_siswa_sma" id="id_siswa_sma" data-placeholder="Select Id Siswa Sma" >
                                    ...
                                    <option value="<?= $row->id_siswa_sma ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa_sma_aktif/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
      ...
      $('#id_kelas').change(function(event) {
        ...
        .done(function(res) {
            var html = '<option value=""></option>';
            $.each(res, function(index, val) {
                html += '<option value="'+val.id_kelas_sma+'">'+val.label+'</option>'
            });
            $('#id_kelas').html(html);
      ...
      $('#id_siswa_sma').change(function(event) {
        ...
        .done(function(res) {
            var html = '<option value=""></option>';
            $.each(res, function(index, val) {
                html += '<option value="'+val.id_siswa_sma+'">'+val.nama_lengkap+'</option>'
            });
