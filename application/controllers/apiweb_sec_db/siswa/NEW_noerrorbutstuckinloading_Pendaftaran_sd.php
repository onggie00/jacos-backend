            ...
            if (!empty($id_siswa)) {
              ...
              if (!empty($data_transaksi)) {
                ...
                if (!empty($get_siswa->va_number_bri)) {
                  ...
                  $get_no_urut = $this->second_db->withquery("select va_number_bri, id_siswa_sd as id_siswa from siswa_sd where va_number_bri like '%" . $brivaNo . date('y', strtotime('+1 years')) . "01%' and va_number_bri != '' and is_mutasi = '2' order by va_number_bri DESC", "row");
