...
<section class="content-header">
    <h1>
        Siswa SMA <small><?= cclang('new', ['Siswa SMA']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa SMA']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_siswa_sma',
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_sma_foto_peserta_uuid" id="siswa_sma_foto_peserta_uuid" type="hidden" value="<?= set_value('siswa_sma_foto_peserta_uuid'); ?>">
                                <input class="data_file" name="siswa_sma_foto_peserta_name" id="siswa_sma_foto_peserta_name" type="hidden" value="<?= set_value('siswa_sma_foto_peserta_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_sma_akte_lahir_uuid" id="siswa_sma_akte_lahir_uuid" type="hidden" value="<?= set_value('siswa_sma_akte_lahir_uuid'); ?>">
                                <input class="data_file" name="siswa_sma_akte_lahir_name" id="siswa_sma_akte_lahir_name" type="hidden" value="<?= set_value('siswa_sma_akte_lahir_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_sma_kartu_keluarga_uuid" id="siswa_sma_kartu_keluarga_uuid" type="hidden" value="<?= set_value('siswa_sma_kartu_keluarga_uuid'); ?>">
                                <input class="data_file" name="siswa_sma_kartu_keluarga_name" id="siswa_sma_kartu_keluarga_name" type="hidden" value="<?= set_value('siswa_sma_kartu_keluarga_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="peminatan_sma" id="peminatan_sma" data-placeholder="Select Peminatan">
                                    ...
                                    <?php foreach (db_get_all_data('peminatan_sma') as $row) : ?>
                                        <option value="<?= $row->id_peminatan_sma ?>"><?= $row->peminatan; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa_sma/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
                .done(function(res) {
                    ...
                    if (res.success) {
                        var id_foto_peserta = $('#siswa_sma_foto_peserta_galery').find('li').attr('qq-file-id');
                        var id_akte_lahir = $('#siswa_sma_akte_lahir_galery').find('li').attr('qq-file-id');
                        var id_kartu_keluarga = $('#siswa_sma_kartu_keluarga_galery').find('li').attr('qq-file-id');
                        ...
                        if (typeof id_foto_peserta !== 'undefined') {
                            $('#siswa_sma_foto_peserta_galery').fineUploader('deleteFile', id_foto_peserta);
                        }
                        if (typeof id_akte_lahir !== 'undefined') {
                            $('#siswa_sma_akte_lahir_galery').fineUploader('deleteFile', id_akte_lahir);
                        }
                        if (typeof id_kartu_keluarga !== 'undefined') {
                            $('#siswa_sma_kartu_keluarga_galery').fineUploader('deleteFile', id_kartu_keluarga);
                        }
