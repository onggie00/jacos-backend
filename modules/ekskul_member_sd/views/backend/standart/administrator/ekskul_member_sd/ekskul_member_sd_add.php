...
<section class="content-header">
    <h1>
        Anggota Ekskul SD        <small><?= cclang('new', ['Anggota Ekskul SD']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Anggota Ekskul SD']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="ekskul_member_sd_file_pembayaran_uuid" id="ekskul_member_sd_file_pembayaran_uuid" type="hidden" value="<?= set_value('ekskul_member_sd_file_pembayaran_uuid'); ?>">
                                <input class="data_file" name="ekskul_member_sd_file_pembayaran_name" id="ekskul_member_sd_file_pembayaran_name" type="hidden" value="<?= set_value('ekskul_member_sd_file_pembayaran_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tahun_ajaran" id="tahun_ajaran" placeholder="<?= date('Y')."/".(date('Y', strtotime('+1 year'))); ?>" value="<?= set_value('tahun_ajaran'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="semester" id="semester" placeholder="1 = Ganjil, 2 = Genap" value="<?= set_value('semester'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/ekskul_member_sd/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_file_pembayaran = $('#ekskul_member_sd_file_pembayaran_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_pembayaran !== 'undefined') {
                    $('#ekskul_member_sd_file_pembayaran_galery').fineUploader('deleteFile', id_file_pembayaran);
                }
