...
<section class="content-header">
    <h1>
        Status Daftar Ulang Ft        <small>Edit Status Daftar Ulang Ft</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Status Daftar Ulang Ft</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/status_daftar_ulang_ft/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input <?= $status_daftar_ulang_ft->status == "0" ? "checked" : ""; ?> type="radio" class="flat-red" name="status" value="0"> Menunggu Aktivasi                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input <?= $status_daftar_ulang_ft->status == "1" ? "checked" : ""; ?> type="radio" class="flat-red" name="status" value="1"> Aktivasi Virtual Account                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input <?= $status_daftar_ulang_ft->status == "2" ? "checked" : ""; ?> type="radio" class="flat-red" name="status" value="2"> Pembayaran Berhasil                                    </label>
                                    </div>
                                    </select>
                        ...
                        <div class="form-group  wrapper-options-crud">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="custom_total_payment" value="<?= ($status_daftar_ulang_ft->custom_payment)?$status_daftar_ulang_ft->custom_payment:0;?>">
                                <div class="row-fluid clear-both">
                                <small class="info help-block text-danger">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_status_daftar_ulang_ft.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#status_daftar_ulang_ft_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
