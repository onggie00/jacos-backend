...
<section class="content-header">
    <h1>
        Jadwal Mapel Sma        <small><?= cclang('new', ['Jadwal Mapel Sma']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Jadwal Mapel Sma']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="senin"> Senin                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="selasa"> Selasa                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="rabu"> Rabu                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="kamis"> Kamis                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="jumat"> Jumat                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="sabtu"> Sabtu                                    </label>
                                    </div>
                                    <div class="col-md-3 padding-left-0">
                                    <label>
                                    <input type="radio" class="flat-red" name="hari" value="minggu"> Minggu                                    </label>
                                    </div>
                                    </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ruang_kelas" id="ruang_kelas" placeholder="Ruang Kelas" value="<?= set_value('ruang_kelas'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/jadwal_mapel_sma/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
