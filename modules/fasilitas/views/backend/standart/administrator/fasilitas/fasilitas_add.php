...
<section class="content-header">
    <h1>
        Fasilitas        <small><?= cclang('new', ['Fasilitas']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Fasilitas']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_fasilitas', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_fasilitas" id="nama_fasilitas" placeholder="Nama Fasilitas" value="<?= set_value('nama_fasilitas'); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="fasilitas_img_fasilitas_uuid" id="fasilitas_img_fasilitas_uuid" type="hidden" value="<?= set_value('fasilitas_img_fasilitas_uuid'); ?>">
                                <input class="data_file" name="fasilitas_img_fasilitas_name" id="fasilitas_img_fasilitas_name" type="hidden" value="<?= set_value('fasilitas_img_fasilitas_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fasilitas/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_img_fasilitas = $('#fasilitas_img_fasilitas_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            if (typeof id_img_fasilitas !== 'undefined') {
                    $('#fasilitas_img_fasilitas_galery').fineUploader('deleteFile', id_img_fasilitas);
                }
